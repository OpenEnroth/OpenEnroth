...
-- The evt file shows the movie on every exit from the map once Xenofex is dead, it sets the quest bit and never checks it.
...
-- A decoration's sprite isn't saved, so the cage would show Roland again after a reload.
