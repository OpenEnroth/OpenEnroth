...
function(source_check_cpp_style TARGET TARGET_SOURCES)
    if(OE_CHECK_CPP_STYLE)
...
function(target_check_cpp_style TARGET)
    if(OE_CHECK_CPP_STYLE)
        get_target_property(TARGET_SOURCES ${TARGET} SOURCES)
        source_check_cpp_style(${TARGET} "${TARGET_SOURCES}")
    endif()
endfunction()
