...
GAME_TEST(Issues, Issue1370) {
    ...
    EXPECT_TRUE(fuzzyEquals(2.55f, pAudioPlayer->getSoundLength(SOUND_EndTurnBasedMode), 0.01f));
    EXPECT_TRUE(fuzzyEquals(2.51f, pAudioPlayer->getSoundLength(static_cast<SoundId>(6480)), 0.01f));
    ...
    EXPECT_TRUE(exprTimeTape.contains(321));  // 2.51 * 128
