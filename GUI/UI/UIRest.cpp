...
void GUIWindow_Rest::Update()
{
    ...
    if (live_characters)
    {
        ...
        {
            rest_ui_hourglass_frame_current = assets->GetImage_ColorKey(StringPrintf("hglas%03d", hourglass_icon_idx), 0x7FF);
        ...
        auto str3 = StringPrintf("%s\r190%d", localization->GetString(56), pParty->uCurrentDayOfMonth + 1);//День
