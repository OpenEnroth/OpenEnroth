...
void MainMenuLoad_EventLoop() {
    while (!pMessageQueue_50CBD0->Empty()) {
        ...
        case UIMSG_SaveLoadBtn: {
            new OnSaveLoad(pGUIWindow_CurrentMenu->uFrameX + 241, pGUIWindow_CurrentMenu->uFrameY + 302, 61, 28, (GUIButton *)pBtnLoadSlot);
            break;
        }
        case UIMSG_DownArrow: {
            ...
            // if (pSaveListPosition < 1)
             //   pSaveListPosition = 0;
            new OnButtonClick2(pGUIWindow_CurrentMenu->uFrameX + 215, pGUIWindow_CurrentMenu->uFrameY + 323, 0, 0, (GUIButton *)pBtnDownArrow);
            break;
        }
        case UIMSG_ArrowUp: {
            --pSaveListPosition;
            if (pSaveListPosition < 0)
                pSaveListPosition = 0;
            new OnButtonClick2(pGUIWindow_CurrentMenu->uFrameX + 215, pGUIWindow_CurrentMenu->uFrameY + 197, 0, 0, (GUIButton *)pBtnArrowUp);
            break;
        }
        case UIMSG_Cancel: {
            new OnCancel3(pGUIWindow_CurrentMenu->uFrameX + 350, pGUIWindow_CurrentMenu->uFrameY + 302, 61, 28, (GUIButton *)pBtnCancel);
            break;
        }
        case UIMSG_Escape: {
