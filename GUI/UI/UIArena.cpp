...
void ArenaFight()
{
  ...
  window.uFrameZ = 452;
  v0 = pFontArrus->CalcTextHeight(localization->GetString(575), window.uFrameWidth, 13) + 7;// Пожалуйста, подождите пока я вызываю существ. Удачи.
  ...
  String v1 = pFontArrus->FitTextInAWindow(localization->GetString(575), window.uFrameWidth, 0xDu);  // Пожалуйста, подождите пока я вызываю существ. Удачи.
