  ...
  GUIWindow(0, 0, window->GetWidth(), window->GetHeight(), uActiveCharacter)
{
  ...
  pCharacterScreen_DetalizBtn = CreateButton(600, 300, 30, 30, 1, 0, UIMSG_ChangeDetaliz, 0, 0, localization->GetString(64));
  pCharacterScreen_DollBtn = CreateButton(476, 0, 164, 345, 1, 0, UIMSG_ClickPaperdoll, 0, 0, "");
...
void GUIWindow_CharacterRecord::ShowStatsTab() {
  ...
  CharacterUI_ReleaseButtons();
  ReleaseAwardsScrollBar();
  new OnButtonClick3(pCharacterScreen_StatsBtn->uX, pCharacterScreen_StatsBtn->uY, 0, 0, (int)pCharacterScreen_StatsBtn);
}
...
void GUIWindow_CharacterRecord::ShowSkillsTab() {
  ...
  ReleaseAwardsScrollBar();
  CharacterUI_SkillsTab_CreateButtons();
  new OnButtonClick3(pCharacterScreen_SkillsBtn->uX, pCharacterScreen_SkillsBtn->uY, 0, 0, (int)pCharacterScreen_SkillsBtn);
}
...
void GUIWindow_CharacterRecord::ShowInventoryTab() {
  ...
  ReleaseAwardsScrollBar();
  CharacterUI_ReleaseButtons();
  new OnButtonClick3(pCharacterScreen_InventoryBtn->uX, pCharacterScreen_InventoryBtn->uY, 0, 0, (int)pCharacterScreen_InventoryBtn);
}
...
void GUIWindow_CharacterRecord::ShowAwardsTab() {
  ...
  new OnButtonClick3(pCharacterScreen_AwardsBtn->uX, pCharacterScreen_AwardsBtn->uY, 0, 0, (int)pCharacterScreen_AwardsBtn);
  FillAwardsData();
}
...
void GUIWindow_CharacterRecord::ToggleRingsOverlay() {
  ...
  pCharacterScreen_DollBtn = pGUIWindow_CurrentMenu->CreateButton(0x1DCu, 0, 0xA4u, 0x159u, 1, 0, UIMSG_ClickPaperdoll, 0, 0, "");
...
GUIWindow *CastSpellInfo::GetCastSpellInInventoryWindow() {
  ...
  GUIWindow *CS_inventory_window = new GUIWindow_Inventory_CastSpell(0, 0, window->GetWidth(), window->GetHeight(), (int)this, 0);
  pCharacterScreen_ExitBtn = CS_inventory_window->CreateButton(394, 318, 75, 33, 1, 0, UIMSG_ClickExitCharacterWindowBtn, 0, 0,
    ...
    { {paperdoll_dbrds[2], paperdoll_dbrds[1]} });
  CS_inventory_window->CreateButton(0, 0, 0x1DCu, 0x159u, 1, 122, UIMSG_InventoryLeftClick, 0, 0, "");
  pCharacterScreen_DollBtn = CS_inventory_window->CreateButton(0x1DCu, 0, 0xA4u, 0x159u, 1, 0, UIMSG_ClickPaperdoll, 0, 0, "");

  CS_inventory_window->CreateButton(61, 424, 31, 0, 2, 94, UIMSG_SelectCharacter, 1, '1', "");
  CS_inventory_window->CreateButton(177, 424, 31, 0, 2, 94, UIMSG_SelectCharacter, 2, '2', "");
  CS_inventory_window->CreateButton(292, 424, 31, 0, 2, 94, UIMSG_SelectCharacter, 3, '3', "");
  CS_inventory_window->CreateButton(407, 424, 31, 0, 2, 94, UIMSG_SelectCharacter, 4, '4', "");
    ...
    if (IsPlayerWearingWatersuit[uPlayerID])//акваланг
    {
        ...
        if (player->GetItem(&PlayerEquipment::uMainHand))
        {
            ...
            if (item->ItemEnchanted())
            {
                ...
                render->BlendTextures(item_X, item_Y, texture, assets->GetImage_ColorKey(container, 0x7FF), OS_GetTime() / 10, 0, 255); // should this pass enchant timer?
    ...
    else// без акваланга
    {
        ...
        if (player->GetItem(&PlayerEquipment::uBow))
        {
            ...
            if (item->ItemEnchanted())// применён закл
            {
                ...
                render->BlendTextures(item_X, item_Y, texture, assets->GetImage_ColorKey(container, 0x7FF), OS_GetTime() / 10, 0, 255);
            }
            else if (item->uAttributes & ITEM_BROKEN)
                render->DrawTransparentRedShade(item_X / 640.0f, item_Y / 480.0f, texture);
            else if (!(item->uAttributes & ITEM_IDENTIFIED))
            ...
            if (index >= 0 && index < 10)
            {
                ...
                if (item->ItemEnchanted())
                {
                    ...
                    render->BlendTextures(
                        item_X, item_Y, paperdoll_cloak_texture[pBodyComplection][index],
                        assets->GetImage_ColorKey(container, 0x7FF), OS_GetTime() / 10, 0, 255
                        );
                }
                else if (item->uAttributes & ITEM_BROKEN)
        ...
        if (player->GetItem(&PlayerEquipment::uArmor))
        {
            ...
            if (index >= 0 && index < 17)
            {
                ...
                if (item->ItemEnchanted())
                {
                    ...
                    render->BlendTextures(
                        item_X, item_Y, paperdoll_armor_texture[pBodyComplection][index][0],
                        assets->GetImage_ColorKey(container, 0x7FF), OS_GetTime() / 10, 0, 255
                    );
                }
                else if (item->uAttributes & ITEM_BROKEN)
                ...
                else//без ничего или с щитом
                {
                    ...
                    if (paperdoll_armor_texture[pBodyComplection][index][1])
                    {
                        ...
                        if (item->ItemEnchanted())
                        {
                            ...
                            render->BlendTextures(
                                item_X, item_Y, paperdoll_armor_texture[pBodyComplection][index][1],
                                assets->GetImage_ColorKey(container, 0x7FF),
                                OS_GetTime() / 10, 0, 255
                            );
                        }
            ...
            if (index >= 0 && index < 10)
            {
                ...
                if (paperdoll_cloak_collar_texture[pBodyComplection][index])
                {
                    if (item->ItemEnchanted())
                    {
                        ...
                        render->BlendTextures(
                            item_X, item_Y, paperdoll_cloak_collar_texture[pBodyComplection][index],
                            assets->GetImage_ColorKey(container, 0x7FF),
                            OS_GetTime() / 10, 0, 255
                        );
                    }
...
void CharacterUI_InventoryTab_Draw(Player *player, bool a2)
{
	...
	for (uint i = 0; i < 126; ++i)
    {
        ...
        pTexture = assets->GetImage_Alpha(player->pInventoryItemList[player->pInventoryMatrix[i] - 1].GetIconName());
		...
		if (player->pInventoryItemList[player->pInventoryMatrix[i] - 1].uAttributes & ITEM_ENCHANT_ANIMATION)
        {
            ...
            {
                case ITEM_AURA_EFFECT_RED:    container = "sptext01"; break;
                case ITEM_AURA_EFFECT_BLUE:   container = "sp28a";    break;
                case ITEM_AURA_EFFECT_GREEN:  container = "sp30a";    break;
                case ITEM_AURA_EFFECT_PURPLE: container = "sp91a";    break;
            }
            _50C9A8_item_enchantment_timer -= pEventTimer->uTimeElapsed;
            if (_50C9A8_item_enchantment_timer <= 0)
            {
                _50C9A8_item_enchantment_timer = 0;
                player->pInventoryItemList[player->pInventoryMatrix[i] - 1].uAttributes &= 0xFFFFFF0F;
                ptr_50C9A4_ItemToEnchant = nullptr;
            }

            render->BlendTextures(uCellX, uCellY, pTexture, assets->GetImage_ColorKey(container, 0x7FF), OS_GetTime() / 10, 0, 255 );
...
static void CharacterUI_DrawItem(int x, int y, ItemGen *item, int id)
{
    ...
    if (item->uAttributes & ITEM_ENCHANT_ANIMATION) // enchant animation
    {
        ...
        {
            case ITEM_AURA_EFFECT_RED:    enchantment_texture = assets->GetImage_ColorKey("sptext01", 0x7FF); break;
            case ITEM_AURA_EFFECT_BLUE:   enchantment_texture = assets->GetImage_ColorKey("sp28a", 0x7FF);    break;
            case ITEM_AURA_EFFECT_GREEN:  enchantment_texture = assets->GetImage_ColorKey("sp30a", 0x7FF);    break;
            case ITEM_AURA_EFFECT_PURPLE: enchantment_texture = assets->GetImage_ColorKey("sp91a", 0x7FF);    break;
        }
...
void CharacterUI_LoadPaperdollTextures()
{
    ...
    if (!ui_character_inventory_paperdoll_background)
        ui_character_inventory_paperdoll_background = assets->GetImage_ColorKey("BACKDOLL", 0x7FF);
    ...
    for (uint i = 0; i < 4; ++i)
    {
        if (pPlayers[i + 1]->HasUnderwaterSuitEquipped())
        {
            ...
            papredoll_dbods[i] = assets->GetImage_Alpha(pContainer);//Body texture
            sprintf(pContainer, "pc23v%dlad", v3);
            papredoll_dlads[i] = assets->GetImage_Alpha(pContainer);// Left Hand
            sprintf(pContainer, "pc23v%dlau", v3);
            papredoll_dlaus[i] = assets->GetImage_Alpha(pContainer);// Left Hand2
            sprintf(pContainer, "pc23v%drh", v3);
            papredoll_drhs[i] = assets->GetImage_Alpha(pContainer);// Right Hand
            sprintf(pContainer, "pc23v%dlh", v3);
            papredoll_dlhs[i] = assets->GetImage_Alpha(pContainer);// Left Palm
            sprintf(pContainer, "pc23v%dlhu", v3);
            papredoll_dlhus[i] = assets->GetImage_Alpha(pContainer); // Left Fist
        ...
        {
            papredoll_dbods[i] = assets->GetImage_Alpha(dbod_texnames_by_face[pPlayers[i + 1]->uCurrentFace]);
            papredoll_dlads[i] = assets->GetImage_Alpha(dlad_texnames_by_face[pPlayers[i + 1]->uCurrentFace]);
            papredoll_dlaus[i] = assets->GetImage_Alpha(dlau_texnames_by_face[pPlayers[i + 1]->uCurrentFace]);
            papredoll_drhs[i] = assets->GetImage_Alpha(drh_texnames_by_face[pPlayers[i + 1]->uCurrentFace]);
            papredoll_dlhs[i] = assets->GetImage_Alpha(dlh_texnames_by_face[pPlayers[i + 1]->uCurrentFace]);
            papredoll_dlhus[i] = assets->GetImage_Alpha(dlhu_texnames_by_face[pPlayers[i + 1]->uCurrentFace]);

            if (pPlayers[i + 1]->uCurrentFace == 12 || pPlayers[i + 1]->uCurrentFace == 13)
            {
                paperdoll_dbrds[pPlayers[i + 1]->uCurrentFace] = assets->GetImage_Alpha(
                    StringPrintf("pc%02dbrd", pPlayers[i + 1]->uCurrentFace + 1)
                );
            }

            papredoll_flying_feet[pPlayers[i + 1]->uCurrentFace] = assets->GetImage_Alpha(
    ...
    for (uint i = 0; i < 4; ++i)
    {
        if (ShouldLoadTexturesForRaceAndGender(i))
        {
            ...
            paperdoll_armor_texture[i][v32][0] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 516, i + 1, 1);
            paperdoll_armor_texture[i][v32][1] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 516, i + 1, 2);
            paperdoll_armor_texture[i][v32][2] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 505, i + 1, 0);
            paperdoll_armor_texture[i][v32 + 1][0] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 505, i + 1, 1);
            paperdoll_armor_texture[i][v32 + 1][1] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 505, i + 1, 2);
            paperdoll_armor_texture[i][v32 + 1][2] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 504, i + 1, 0);
            paperdoll_armor_texture[i][v32 + 2][0] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 504, i + 1, 1);
            paperdoll_armor_texture[i][v32 + 2][1] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 504, i + 1, 2);
            paperdoll_armor_texture[i][v32 + 2][2] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 533, i + 1, 0);
            paperdoll_armor_texture[i][v32 + 3][0] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 533, i + 1, 1);
            paperdoll_armor_texture[i][v32 + 3][1] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 533, i + 1, 2);
            paperdoll_armor_texture[i][v32 + 3][2] = assets->GetImage_Alpha(pContainer);
            ...
            paperdoll_cloak_collar_texture[i][5] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 530, i + 1, 1);
            paperdoll_cloak_collar_texture[i][6] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 547, i + 1, 1);
            paperdoll_cloak_collar_texture[i][7] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 548, i + 1, 1);
            paperdoll_cloak_collar_texture[i][8] = assets->GetImage_Alpha(pContainer);
            GetItemTextureFilename(pContainer, 550, i + 1, 1);
            paperdoll_cloak_collar_texture[i][9] = assets->GetImage_Alpha(pContainer);
        }
        //else
        //{
          //v26 = v43;
...
void GUIWindow_CharacterRecord::CharacterUI_SkillsTab_CreateButtons() {
  ...
  for (int i = 0; i < 9; ++i) {
    ...
    if (curr_player->pActiveSkills[skill_id] & 0x3F) {
      ...
      ++buttons_count;
      ++first_rows;
      pGUIWindow_CurrentMenu->CreateButton(24, current_Y, 204, uCurrFontHeght - 3, 3, skill_id | 0x8000, UIMSG_SkillUp, skill_id, 0, "");
    }
  }
  if (!first_rows)
    current_Y += uCurrFontHeght - 3;
  ...
  for (int i = 0; i < 5; ++i) {
    ...
    if (curr_player->pActiveSkills[skill_id] & 0x3F) {
      ...
      ++buttons_count;
      ++first_rows;
      pGUIWindow_CurrentMenu->CreateButton(246, current_Y, 204, uCurrFontHeght - 3, 3, skill_id | 0x8000, UIMSG_SkillUp, skill_id, 0, "");
    }
  }
  if (!first_rows)
    current_Y += uCurrFontHeght - 3;
  ...
  if (buttons_count) {
    pGUIWindow_CurrentMenu->_41D08F_set_keyboard_control_group(buttons_count, 1, 0, buttons_count);
  }
}
...
void WetsuitOff(unsigned int uPlayerID)
{
    if (uPlayerID > 0)
    {
        papredoll_dbods[uPlayerID - 1] = assets->GetImage_Alpha(dbod_texnames_by_face[pPlayers[uPlayerID]->uCurrentFace]);
        papredoll_dlads[uPlayerID - 1] = assets->GetImage_Alpha(dlad_texnames_by_face[pPlayers[uPlayerID]->uCurrentFace]);
        papredoll_dlaus[uPlayerID - 1] = assets->GetImage_Alpha(dlau_texnames_by_face[pPlayers[uPlayerID]->uCurrentFace]);
        papredoll_drhs[uPlayerID - 1] = assets->GetImage_Alpha(drh_texnames_by_face[pPlayers[uPlayerID]->uCurrentFace]);
        papredoll_dlhs[uPlayerID - 1] = assets->GetImage_Alpha(dlh_texnames_by_face[pPlayers[uPlayerID]->uCurrentFace]);
        papredoll_dlhus[uPlayerID - 1] = assets->GetImage_Alpha(dlhu_texnames_by_face[pPlayers[uPlayerID]->uCurrentFace]);

        wchar_t name[1024];
        if (pPlayers[uPlayerID]->uCurrentFace == 12 || pPlayers[uPlayerID]->uCurrentFace == 13)
        {
            paperdoll_dbrds[pPlayers[uPlayerID]->uCurrentFace] = assets->GetImage_Alpha(
                StringPrintf("pc%02dbrd", pPlayers[uPlayerID]->uCurrentFace + 1)
            );
        }

        papredoll_flying_feet[pPlayers[uPlayerID]->uCurrentFace] = assets->GetImage_Alpha(
...
//  unsigned int v48; // [sp+30h] [bp-1Ch]@88
  ...
  if (mainhandequip && pPlayers[uActiveCharacter]->pInventoryItemList[mainhandequip - 1].GetItemEquipType() == EQUIP_TWO_HANDED )
	...
	if ( pParty->pPickedItem.uItemID ) { // hold item
		...
		switch ( pEquipType ) {
			...
			case EQUIP_AMULET:
				...
				if ( pPlayers[uActiveCharacter]->HasUnderwaterSuitEquipped() && (pEquipType != EQUIP_ARMOUR || bUnderwater) ) { // cant put anything on wearing wetsuit
					pAudioPlayer->PlaySound(SOUND_error, 0, 0, -1, 0, 0, 0, 0);
					return;
				}

				pPlayers[uActiveCharacter]->EquipBody(pEquipType); // equips item

				if ( pParty->pPickedItem.uItemID == ITEM_WETSUIT ) // just taken wetsuit off
			...
			case EQUIP_RING:
				...
				if (!bRingsShownInCharScreen) { // rings not displayd
					...
					for ( int equippos = 0; equippos < 6; ++equippos ) {
						if (!pPlayers[uActiveCharacter]->pEquipment.uRings[equippos]) { // 0 to 5
							...
							if (freeslot >= 0) { // drop ring into free space
								...
								memcpy(&pPlayers[uActiveCharacter]->pInventoryItemList[freeslot], &pParty->pPickedItem, sizeof(pPlayers[uActiveCharacter]->pInventoryItemList[freeslot]));
								pPlayers[uActiveCharacter]->pEquipment.uRings[equippos] = freeslot + 1;
					...
					freeslot = pPlayers[uActiveCharacter]->pEquipment.uRings[5] - 1; // slot of last ring
					memcpy(&_this, &pParty->pPickedItem, sizeof(_this)); // copy hold item to this 
					pPlayers[uActiveCharacter]->pInventoryItemList[freeslot].uBodyAnchor = 0;
					pParty->pPickedItem.Reset(); // drop holding item
					pParty->SetHoldingItem(&pPlayers[uActiveCharacter]->pInventoryItemList[freeslot]); // set holding item to ring to swap out
					_this.uBodyAnchor = 16;
					memcpy(&pPlayers[uActiveCharacter]->pInventoryItemList[freeslot], &_this, 0x24u); // swap from this in
					pPlayers[uActiveCharacter]->pEquipment.uRings[5] = freeslot + 1; // anchor
					return;
					...
					// if in ring area
					for (int i = 0; i < 6; ++i) {
						if (mousex >= RingsX[i] && mousex <= (RingsX[i] + slot) && mousey >= RingsY[i] && mousey <= (RingsY[i] + slot)) { // check against ring slots
							pos = i;
						}
					}
					...
					if (pos != -1) { // we have a position to aim for
						...
						if (!pitem) { // no item in slot so just drop
							...
							if (freeslot >= 0) { // drop ring into free space
								...
								memcpy(&pPlayers[uActiveCharacter]->pInventoryItemList[freeslot], &pParty->pPickedItem, sizeof(pPlayers[uActiveCharacter]->pInventoryItemList[freeslot]));
								pPlayers[uActiveCharacter]->pEquipment.uRings[pos] = freeslot + 1;
								pMouse->RemoveHoldingItem();
								return;
							}
						}
							...
							freeslot = pPlayers[uActiveCharacter]->pEquipment.uRings[pos] - 1; // slot of ring selected
							memcpy(&_this, &pParty->pPickedItem, sizeof(_this)); // copy hold item to this 
							pPlayers[uActiveCharacter]->pInventoryItemList[freeslot].uBodyAnchor = 0;
							pParty->pPickedItem.Reset(); // drop holding item
							pParty->SetHoldingItem(&pPlayers[uActiveCharacter]->pInventoryItemList[freeslot]); // set holding item to ring to swap out
							...
							memcpy(&pPlayers[uActiveCharacter]->pInventoryItemList[freeslot], &_this, 0x24u); // swap from this in
							pPlayers[uActiveCharacter]->pEquipment.uRings[pos] = freeslot + 1; // anchor
							return;
...
//------------------dress shield(одеть щит)------------------------------------------------------
      case EQUIP_SHIELD://Щит
        ...
        if (shieldequip)//смена щита щитом
        {
          ...
          pPlayers[uActiveCharacter]->pInventoryItemList[shieldequip].uBodyAnchor = 0;
          pParty->pPickedItem.Reset();
          pParty->SetHoldingItem(&pPlayers[uActiveCharacter]->pInventoryItemList[shieldequip]);
          _this.uBodyAnchor = 1;
          memcpy(&pPlayers[uActiveCharacter]->pInventoryItemList[shieldequip], &_this, 0x24u);
          pPlayers[uActiveCharacter]->pEquipment.uShield = shieldequip + 1;
          if (twohandedequip == EQUIP_SINGLE_HANDED )
            return;
        }
        else
        {
          ...
          pParty->pPickedItem.Reset();
          pParty->SetHoldingItem(&pPlayers[uActiveCharacter]->pInventoryItemList[mainhandequip]);
          _this.uBodyAnchor = 1;
          memcpy(&pPlayers[uActiveCharacter]->pInventoryItemList[freeslot], &_this, sizeof(pPlayers[uActiveCharacter]->pInventoryItemList[freeslot]));
          pPlayers[uActiveCharacter]->pEquipment.uShield = freeslot + 1;
        }
...
//-------------------------taken in hand(взять в руку)-------------------------------------------
      ...
      case EQUIP_WAND:
        ...
        pParty->SetHoldingItem(&pPlayers[uActiveCharacter]->pInventoryItemList[mainhandequip]);
        _this.uBodyAnchor = 2;
        memcpy(&pPlayers[uActiveCharacter]->pInventoryItemList[mainhandequip], &_this, 0x24);
        pPlayers[uActiveCharacter]->pEquipment.uMainHand = mainhandequip + 1;
        if ( pEquipType == EQUIP_WAND )
          v50 = _this.uItemID;
        if (twohandedequip)
...
//---------------------------take two hands(взять двумя руками)---------------------------------
      case EQUIP_TWO_HANDED:
        ...
        if (mainhandequip)//взять двуручный меч когда нет щита(замещение оружия)
        {
          ...
          pParty->SetHoldingItem(&pPlayers[uActiveCharacter]->pInventoryItemList[mainhandequip]);
          _this.uBodyAnchor = 2;
          memcpy(&pPlayers[uActiveCharacter]->pInventoryItemList[mainhandequip], &_this, 0x24u);
          pPlayers[uActiveCharacter]->pEquipment.uMainHand = mainhandequip + 1;
        }
        else
        {
          ...
          if (freeslot >= 0 )
          {
            if (shieldequip)//взять двуручный меч когда есть щит(замещение щитом)
            {
              ...
              memcpy(&pPlayers[uActiveCharacter]->pInventoryItemList[freeslot], &_this, sizeof(pPlayers[uActiveCharacter]->pInventoryItemList[freeslot]));
              pPlayers[uActiveCharacter]->pEquipment.uShield = 0;
              pPlayers[uActiveCharacter]->pEquipment.uMainHand = freeslot + 1;
            }
            else
            {
              pParty->pPickedItem.uBodyAnchor = 2;
