...
void GUIWindow_MainMenu::EventLoop() {
    while (!pMessageQueue_50CBD0->Empty()) {
        ...
        case UIMSG_MainMenu_ShowPartyCreationWnd:
            new OnButtonClick2(495, 172, 0, 0, (GUIButton *)pBtnNew);
            SetCurrentMenuID(MENU_NEWGAME);
            break;
        case UIMSG_MainMenu_ShowLoadWindow:
            new OnButtonClick2(495, 227, 0, 0, (GUIButton *)pBtnLoad);
            SetCurrentMenuID(MENU_SAVELOAD);
            break;
        case UIMSG_ShowCredits:
            new OnButtonClick2(495, 282, 0, 0, (GUIButton *)pBtnCredits);
            SetCurrentMenuID(MENU_CREDITS);
            break;
        case UIMSG_ExitToWindows:
            new OnButtonClick2(495, 337, 0, 0, (GUIButton *)pBtnExit);
