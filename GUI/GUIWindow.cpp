    ...
    GUIWindow(x, y, width, height, button, hint)
{
    ...
    GameUI_StatusBar_OnEvent(localization->GetString(39)); // Choose target / ¬ыберите цель
}
...
void GUIWindow::DrawMessageBox(bool inside_game_viewport) {
  ...
  if (!sHint.empty()) {
    uBoxHeight = pFontLucida->CalcTextHeight(sHint, current_window.uFrameWidth, 0) + 24;
  } else {
  ...
  DrawPopupWindow(this->uFrameX, this->uFrameY, this->uFrameWidth, uBoxHeight);
  if (!sHint.empty()) {
    current_window.DrawTitleText(pFontLucida, 0, (int)(uBoxHeight - pFontLucida->CalcTextHeight(this->sHint, current_window.uFrameWidth, 0)) / 2 - 14, 0, this->sHint, 3);
  }
}
...
void GUIWindow::HouseDialogManager() {
  ...
  if (pDialogueNPCCount != uNumDialogueNPCPortraits || !uHouse_ExitPic) {
    const char *pHouseName = p2DEvents[(unsigned int)window_SpeakInHouse->ptr_1C - 1].pName;
    if (pHouseName) {
    ...
    const char *pInString, int uLineSpacing)
{
  ...
  String resString = pFont->FitTextInAWindow(pInString, this->uFrameWidth, uHorizontalMargin);
...
void DrawJoinGuildWindow( int pEventCode )
{
  ...
  pBtn_ExitCancel = pDialogueWindow->CreateButton(471, 445, 169, 35, 1, 0, UIMSG_Escape, 0, 0, localization->GetString(34), { { ui_exit_cancel_button_background } }); // Cancel
                    pDialogueWindow->CreateButton(  0,   0,   0,  0, 1, 0, UIMSG_BuyInShop_Identify_Repair, 0, 0, "");
                    pDialogueWindow->CreateButton(480, 160, 140, 30, 1, 0, UIMSG_ClickNPCTopic,             82, 0, localization->GetString(122));
...
void CreateScrollWindow() {
  ...
  a1.uFrameY = 1;
  a1.uFrameWidth = 468;
  unsigned int v0 = pFontSmallnum->CalcTextHeight(pScrolls[pGUIWindow_ScrollWindow->par1C], a1.uFrameWidth, 0) + 2 * (unsigned char)pFontCreate->GetHeight() + 24;
  a1.uFrameHeight = v0;
...
void SetUserInterface(PartyAlignment align, bool bReplace)
{
    ...
    if (align == PartyAlignment_Evil)
    {
        if (bReplace)
        {
            ...
            game_ui_minimap_compass = assets->GetImage_ColorKey("IB-COMP-C", 0x7FF);
            ...
            game_ui_player_selection_frame = assets->GetImage_ColorKey("IB-selec-C", 0x7FF);
            ...
            game_ui_playerbuff_bless = assets->GetImage_ColorKey("isg-01-c", 0x7FF);
            game_ui_playerbuff_preservation = assets->GetImage_ColorKey("isg-02-c", 0x7FF);
            game_ui_playerbuff_hammerhands = assets->GetImage_ColorKey("isg-03-c", 0x7FF);
            game_ui_playerbuff_pain_reflection = assets->GetImage_ColorKey("isg-04-c", 0x7FF);
            ...
            ui_exit_cancel_button_background = assets->GetImage_ColorKey("ib-bcu-c", 0x7FF);

            game_ui_evtnpc = assets->GetImage_ColorKey("evtnpc-c", 0x7FF);
            ui_character_inventory_background = assets->GetImage_ColorKey("fr_inven-c", 0x7FF);
        ...
        else
        {
            ...
            ui_btn_npc_left = assets->GetImage_ColorKey("IB-NPCLD-C", 0x7FF);
            ui_btn_npc_right = assets->GetImage_ColorKey("IB-NPCRD-C", 0x7FF);
            game_ui_btn_zoomin = assets->GetImage_ColorKey("ib-autout-C", 0x7FF);
            game_ui_btn_zoomout = assets->GetImage_ColorKey("ib-autin-C", 0x7FF);
            game_ui_player_selection_frame = assets->GetImage_ColorKey("IB-selec-C", 0x7FF);
            game_ui_btn_cast = assets->GetImage_Alpha("ib-m1d-c");
            game_ui_btn_rest = assets->GetImage_Alpha("ib-m2d-c");
            game_ui_btn_quickref = assets->GetImage_Alpha("ib-m3d-c");
            ...
            game_ui_evtnpc = assets->GetImage_ColorKey("evtnpc-c", 0x7FF);
            ui_character_inventory_background = assets->GetImage_ColorKey("fr_inven", 0x7FF);
    ...
    else if (align == PartyAlignment_Neutral)
    {
        if (bReplace)
        {
            ...
            game_ui_minimap_compass = assets->GetImage_ColorKey("IB-COMP-a", 0x7FF);
            ...
            game_ui_btn_zoomin = assets->GetImage_ColorKey("ib-autout-a", 0x7FF);
            game_ui_btn_zoomout = assets->GetImage_ColorKey("ib-autin-a", 0x7FF);
            game_ui_player_selection_frame = assets->GetImage_ColorKey("IB-selec-a", 0x7FF);
            ...
            game_ui_playerbuff_bless = assets->GetImage_ColorKey("isg-01-a", 0x7FF);
            game_ui_playerbuff_preservation = assets->GetImage_ColorKey("isg-02-a", 0x7FF);
            game_ui_playerbuff_hammerhands = assets->GetImage_ColorKey("isg-03-a", 0x7FF);
            game_ui_playerbuff_pain_reflection = assets->GetImage_ColorKey("isg-04-a", 0x7FF);
            ...
            ui_exit_cancel_button_background = assets->GetImage_ColorKey("ib-bcu-a", 0x7FF);
    ...
    else if (align == PartyAlignment_Good)
    {
        if (bReplace)
        {
            ...
            game_ui_minimap_compass = assets->GetImage_ColorKey("IB-COMP-B", 0x7FF);
            ...
            game_ui_btn_zoomin = assets->GetImage_ColorKey("ib-autout-B", 0x7FF);
            game_ui_btn_zoomout = assets->GetImage_ColorKey("ib-autin-B", 0x7FF);
            game_ui_player_selection_frame = assets->GetImage_ColorKey("IB-selec-B", 0x7FF);
            ...
            game_ui_playerbuff_bless = assets->GetImage_ColorKey("isg-01-b", 0x7FF);
            game_ui_playerbuff_preservation = assets->GetImage_ColorKey("isg-02-b", 0x7FF);
            game_ui_playerbuff_hammerhands = assets->GetImage_ColorKey("isg-03-b", 0x7FF);
            game_ui_playerbuff_pain_reflection = assets->GetImage_ColorKey("isg-04-b", 0x7FF);
            ...
            ui_exit_cancel_button_background = assets->GetImage_ColorKey("ib-bcu-b", 0x7FF);
            game_ui_evtnpc = assets->GetImage_ColorKey("evtnpc-b", 0x7FF);
            ui_character_inventory_background = assets->GetImage_ColorKey("fr_inven-b", 0x7FF);
...
void _4B3FE5_training_dialogue(int a4) {
  ...
  pDialogueWindow->CreateButton(0, 0, 0, 0, 1, 0, UIMSG_BuyInShop_Identify_Repair, 0, 0, "");
  pDialogueWindow->CreateButton(480, 160, 0x8Cu, 0x1Eu, 1, 0, UIMSG_ClickNPCTopic, 0x4Fu, 0, contract_approved ? localization->GetString(535) : "");
  pDialogueWindow->_41D08F_set_keyboard_control_group(1, 1, 0, 2);
  dialog_menu_id = HOUSE_DIALOGUE_OTHER;
}
...
void CheckBountyRespawnAndAward() {
  ...
  pDialogueWindow->CreateButton(0, 0, 0, 0, 1, 0, UIMSG_BuyInShop_Identify_Repair, 0, 0, "");
  pDialogueWindow->CreateButton(480, 160, 140, 30, 1, 0, UIMSG_0, 83, 0, "");
  pDialogueWindow->_41D08F_set_keyboard_control_group(1, 1, 0, 2);
  dialog_menu_id = HOUSE_DIALOGUE_OTHER;
...
String _4B254D_SkillMasteryTeacher(int trainerInfo)
{
	...
	if (currClassMaxMastery < masteryLevelBeingTaught)
	{
        ...
        {
            return localization->FormatString(633, localization->GetClassName(classBaseId + 1)); // You have to be promoted to %s to learn this skill level.   /   ¬ы должны достичь звани€ %s дл€ обучени€ этому уровню навыка.
        }
        ...
        {
            return localization->FormatString(634, localization->GetClassName(classBaseId + 2), localization->GetClassName(classBaseId + 3)); // You have to be promoted to %s or %s to learn this skill level.   /   ¬ы должны достичь звани€ %s или %s дл€ обучени€ этому уровню навыка.
        }
        else if (byte_4ED970_skill_learn_ability_by_class_table[classBaseId + 2][skillBeingTaught] >= masteryLevelBeingTaught)
        {
            return localization->FormatString(633, localization->GetClassName(classBaseId + 2)); // You have to be promoted to %s to learn this skill level.   /   ¬ы должны достичь звани€ %s дл€ обучени€ этому уровню навыка.
        }
        else if (byte_4ED970_skill_learn_ability_by_class_table[classBaseId + 3][skillBeingTaught] >= masteryLevelBeingTaught)
        {
            return localization->FormatString(633, localization->GetClassName(classBaseId + 3)); // You have to be promoted to %s to learn this skill level.   /   ¬ы должны достичь звани€ %s дл€ обучени€ этому уровню навыка.
        }
        else
        {
            return localization->FormatString(632, localization->GetClassName(pClassType)); // This skill level can not be learned by the %s class.   /   Ётот уровень навыка не может быть постигнут классом %s.
        }
	}
	...
	if (masteryLevelBeingTaught == 2)
	{
        return localization->FormatString(
            534, // ѕолучить степень ^Pr[%s] в навыке ^Pr[%s] за ^I[%lu] золот^L[ой;ых;ых]
		...
		else
		{
			...
			case 16:
				if (npc->uSex)
                    ...
                    result += localization->GetString(390);// "brother"
				break;
			case 17: // hired npc text   текст наЄмного Ќѕ—
			{
