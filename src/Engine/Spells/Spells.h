...
enum SPELL_TYPE {
    ...
    SPELL_REGULAR_COUNT = SPELL_DARK_SOULDRINKER + 1,

    SPELL_BOW_ARROW = 100,
    SPELL_101 = 101,
    SPELL_LASER_PROJECTILE = 102,

    SPELL_ANY_WITH_SPRITE_COUNT = SPELL_LASER_PROJECTILE + 1,
...
extern std::array<SPRITE_OBJECT_TYPE, SPELL_ANY_WITH_SPRITE_COUNT> SpellSpriteMapping;  // 4E3ACC
