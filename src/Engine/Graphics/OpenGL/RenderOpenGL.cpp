...
int RenderOpenGL::forEachActorInViewport(int pDepth, std::function<void(Actor&)> callback) {
    int actors_num = 0;
    for (int i = 0; i < uNumBillboardsToDraw; i++) {
        ...
        int pid = pBillboardRenderList[render_id].object_pid;
