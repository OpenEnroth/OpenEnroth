...
void OpenGLRenderer::DoRenderBillboards_D3D() {
    ...
    for (int i = uNumBillboardsToDraw - 1; i >= 0; --i) {
        ...
        v0.screenspace = billboard->view_space_z;
        v0.texid = gltexid;
        v0.blend = thisblend;
        v0.paletteId = paletteId;
        ...
        v1.screenspace = billboard->view_space_z;
        v1.texid = gltexid;
        v1.blend = thisblend;
        v1.paletteId = paletteId;
        ...
        v2.screenspace = billboard->view_space_z;
        v2.texid = gltexid;
        v2.blend = thisblend;
        v2.paletteId = paletteId;
        ...
        if (billboard->pQuads[3].pos.x != 0.0f && billboard->pQuads[3].pos.y != 0.0f && billboard->pQuads[3].pos.z != 0.0f) {
            ...
            v3.screenspace = billboard->view_space_z;
            v3.texid = gltexid;
            v3.blend = thisblend;
            v3.paletteId = paletteId;
            ...
            v4.screenspace = billboard->view_space_z;
            v4.texid = gltexid;
            v4.blend = thisblend;
            v4.paletteId = paletteId;
            ...
            v5.screenspace = billboard->view_space_z;
            v5.texid = gltexid;
            v5.blend = thisblend;
            v5.paletteId = paletteId;
        }
