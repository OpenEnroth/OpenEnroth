        ...
        if (pSpriteObjects[i].uObjectDescID) {
            if (pSpriteObjects[i].containing_item.itemId != ITEM_NULL) {
                if (pSpriteObjects[i].containing_item.itemId != ITEM_POTION_BOTTLE &&
                    pItemTable->pItems[pSpriteObjects[i].containing_item.itemId].type == ITEM_TYPE_POTION &&
...
int DropTreasureAt(ItemTreasureLevel trs_level, RandomItemType trs_type, Vec3f pos, uint16_t facing) {
    ...
    a1.uType = pItemTable->pItems[a1.containing_item.itemId].spriteId;
...
void SpawnRandomTreasure(MapInfo *mapInfo, SpawnPoint *a2) {
    ...
    if (v13 != ITEM_TREASURE_LEVEL_7) {
        ...
        a1a.uType = pItemTable->pItems[a1a.containing_item.itemId].spriteId;
