...
struct Player {
    ...
    union {
        struct {
            CombinedSkillValue skillStaff;
            CombinedSkillValue skillSword;
            CombinedSkillValue skillDagger;
            CombinedSkillValue skillAxe;
            CombinedSkillValue skillSpear;
            CombinedSkillValue skillBow;
            CombinedSkillValue skillMace;
            CombinedSkillValue skillBlaster;
            CombinedSkillValue skillShield;
            CombinedSkillValue skillLeather;
            CombinedSkillValue skillChain;
            CombinedSkillValue skillPlate;
            CombinedSkillValue skillFire;
            CombinedSkillValue skillAir;
            CombinedSkillValue skillWater;
            CombinedSkillValue skillEarth;
            CombinedSkillValue skillSpirit;
            CombinedSkillValue skillMind;
            CombinedSkillValue skillBody;
            CombinedSkillValue skillLight;
            CombinedSkillValue skillDark;
            CombinedSkillValue skillItemId;
            CombinedSkillValue skillMerchant;
            CombinedSkillValue skillRepair;
            CombinedSkillValue skillBodybuilding;
            CombinedSkillValue skillMeditation;
            CombinedSkillValue skillPerception;
            CombinedSkillValue skillDiplomacy;
            CombinedSkillValue skillThievery;
            CombinedSkillValue skillDisarmTrap;
            CombinedSkillValue skillDodge;
            CombinedSkillValue skillUnarmed;
            CombinedSkillValue skillMonsterId;
            CombinedSkillValue skillArmsmaster;
            CombinedSkillValue skillStealing;
            CombinedSkillValue skillAlchemy;
            CombinedSkillValue skillLearning;
            CombinedSkillValue skillClub;
        };
