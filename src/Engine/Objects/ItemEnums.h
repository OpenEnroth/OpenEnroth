...
enum class ITEM_TYPE : int32_t {
    ...
    ITEM_POTION_FREEZING_POTION = 247,
    ITEM_POTION_NOXIOUS_POTION = 248,
    ITEM_POTION_SHOCKING_POTION = 249,
    ...
    ITEM_MESSAGE_MESSAGE_FROM_MR_STANTLEY = 704,
    ...
    ITEM_MESSAGE_REJUVENATION_RECIPE = 740,
    ITEM_MESSAGE_PURE_MIGHT_RECIPE = 741,
    ITEM_MESSAGE_PURE_ACCURACY_RECIPE = 742,
    ITEM_MESSAGE_PURE_PERSONALITY_RECIPE = 743,
    ITEM_MESSAGE_PURE_ENDURANCE_RECIPE = 744,
    ITEM_MESSAGE_PURE_INTELLECT_RECIPE = 745,
    ITEM_MESSAGE_PURE_SPEED_RECIPE = 746,
    ITEM_MESSAGE_PURE_LUCK_RECIPE = 747,
    ITEM_MESSAGE_SLAYING_POTION_RECIPE = 748,
    ITEM_MESSAGE_STONE_TO_FLESH_RECIPE = 749,
    ITEM_MESSAGE_MIGHT_BOOST_RECIPE = 750,
    ITEM_MESSAGE_INTELLECT_BOOST_RECIPE = 751,
    ITEM_MESSAGE_PERSONALITY_BOOST_RECIPE = 752,
    ITEM_MESSAGE_ENDURANCE_BOOST_RECIPE = 753,
    ITEM_MESSAGE_SPEED_BOOST_RECIPE = 754,
    ITEM_MESSAGE_ACCURACY_BOOST_RECIPE = 755,
    ITEM_MESSAGE_FLAMING_POTION_RECIPE = 756,
    ITEM_MESSAGE_FREEZING_POTION_RECIPE = 757,
    ITEM_MESSAGE_NOXIOUS_POTION_RECIPE = 758,
    ITEM_MESSAGE_SHOCKING_POTION_RECIPE = 759,
    ITEM_MESSAGE_SWIFT_POTION_RECIPE = 760,
    ITEM_MESSAGE_CURE_PARALYSIS_RECIPE = 761,
    ITEM_MESSAGE_DIVINE_RESTORATION_RECIPE = 762,
    ITEM_MESSAGE_DIVINE_CURE_RECIPE = 763,
    ITEM_MESSAGE_DIVINE_POWER_RECIPE = 764,
    ITEM_MESSAGE_LUCK_BOOST_RECIPE = 765,
    ITEM_MESSAGE_FIRE_RESISTANCE_RECIPE = 766,
    ITEM_MESSAGE_AIR_RESISTANCE_RECIPE = 767,
    ITEM_MESSAGE_WATER_RESISTANCE_RECIPE = 768,
    ITEM_MESSAGE_EARTH_RESISTANCE_RECIPE = 769,
    ITEM_MESSAGE_MIND_RESISTANCE_RECIPE = 770,
    ITEM_MESSAGE_BODY_RESISTANCE_RECIPE = 771,
