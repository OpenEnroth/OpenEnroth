    ...
    switch (profession) {
        ...
        case WindMaster: {
            if (uCurrentlyLoadedLevelType == LEVEL_INDOOR) {
                ...
                pParty->pPartyBuffs[PARTY_BUFF_FLY]
                    .Apply(pParty->GetPlayingTime() + Time::fromHours(2), CHARACTER_SKILL_MASTERY_MASTER, 0, 0, 0);
        ...
        case WaterMaster: {
            pParty->pPartyBuffs[PARTY_BUFF_WATER_WALK]
                .Apply(pParty->GetPlayingTime() + Time::fromHours(3), CHARACTER_SKILL_MASTERY_MASTER, 0, 0, 0);
            // Mark buff as GM because NPC buff does not drain mana
