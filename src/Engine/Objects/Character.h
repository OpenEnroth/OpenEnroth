...
class Character {
 public:
    ...
    std::string name;
    Sex uSex = SEX_MALE;
    Class classType = CLASS_KNIGHT;
    uint8_t uCurrentFace = 0;
    ...
    int16_t sACModifier = 0;
    uint16_t uLevel = 0;
    int16_t sLevelModifier = 0;
    int16_t sAgeModifier = 0;
    ...
    int16_t sResFireBase = 0;
    int16_t sResAirBase = 0;
    int16_t sResWaterBase = 0;
    int16_t sResEarthBase = 0;
    int16_t sResPhysicalBase = 0;
    int16_t sResMagicBase = 0;
    int16_t sResSpiritBase = 0;
    int16_t sResMindBase = 0;
    int16_t sResBodyBase = 0;
    int16_t sResLightBase = 0;
    int16_t sResDarkBase = 0;
    int16_t sResFireBonus = 0;
    int16_t sResAirBonus = 0;
    int16_t sResWaterBonus = 0;
    int16_t sResEarthBonus = 0;
    int16_t sResPhysicalBonus = 0;
    int16_t sResMagicBonus = 0;
    int16_t sResSpiritBonus = 0;
    int16_t sResMindBonus = 0;
    int16_t sResBodyBonus = 0;
    int16_t sResLightBonus = 0;
    int16_t sResDarkBonus = 0;
    ...
    int mana = 0;
    int uBirthYear = 0;
    MagicSchool lastOpenedSpellbookPage = MAGIC_SCHOOL_FIRE;
    SpellId uQuickSpell = SPELL_NONE;
    IndexedBitset<1, 512> _characterEventBits;
    char _some_attack_bonus = 0;
    char _melee_dmg_bonus = 0;
    char _ranged_atk_bonus = 0;
    char _ranged_dmg_bonus = 0;
    char uFullHealthBonus = 0;
    char _health_related = 0;
    char uFullManaBonus = 0;
    char _mana_related = 0;
    PortraitId portrait = PORTRAIT_INVALID;
    Duration portraitTimePassed;
    Duration portraitTimeLength;
    int16_t portraitImageIndex = 0;
    TalkAnimation talkAnimation;
    std::array<std::optional<LloydBeacon>, 5> vBeacons;
    char uNumDivineInterventionCastsThisDay = 0;
    char uNumArmageddonCasts = 0;
    char uNumFireSpikeCasts = 0;
};
