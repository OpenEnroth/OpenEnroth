...
MonsterId MonsterStats::FindMonsterByTextureName(const std::string &monster_textr_name) {
    for (MonsterId i : pInfos.indices()) {
        if (!pInfos[i].name.empty() && iequals(pInfos[i].textureName, monster_textr_name))
            return i;
    }
            ...
            if (temp_str_len) {
                switch (decode_step) {
                    case 0:
                        ...
                        pInfos[curr_rec_num].id = curr_rec_num;
                        break;
                    case 1:
                        pInfos[curr_rec_num].name = removeQuotes(test_string);
                        break;
                    case 2:
                        pInfos[curr_rec_num].textureName = removeQuotes(test_string);
                        break;
                    case 3:
                        pInfos[curr_rec_num].level = atoi(test_string);
                        break;
                    case 4: {
                        int str_len = 0;
                        int str_pos = 0;
                        pInfos[curr_rec_num].hp = 0;
                        ...
                        while ((test_string[str_pos] != ',') &&
                            ...
                            ++str_pos;
                        if (str_len == str_pos) {
                            pInfos[curr_rec_num].hp = atoi(test_string);
                        } else {
                            test_string[str_pos] = '\0';
                            pInfos[curr_rec_num].hp = 1000 * atoi(test_string);
                            pInfos[curr_rec_num].hp +=
                                atoi(&test_string[str_pos + 1]);
                            test_string[str_pos] = ',';
                        }
                    } break;
                    case 5:
                        pInfos[curr_rec_num].ac = atoi(test_string);
                        break;
                    case 6: {
                        int str_len = 0;
                        int str_pos = 0;
                        pInfos[curr_rec_num].exp = 0;
                        if (test_string[0] == '"') test_string[0] = ' ';
                        str_len = strlen(test_string);
                        if (str_len == 0) break;
                        while ((test_string[str_pos] != ',') &&
                            ...
                            ++str_pos;
                        if (str_len == str_pos) {
                            pInfos[curr_rec_num].exp = atoi(test_string);
                        } else {
                            test_string[str_pos] = '\0';
                            pInfos[curr_rec_num].exp =
                    ...
                    case 7: {
                        ...
                        char *item_name;
                        pInfos[curr_rec_num].treasureDropChance = 0;
                        pInfos[curr_rec_num].goldDiceRolls = 0;
                        pInfos[curr_rec_num].goldDiceSides = 0;
                        pInfos[curr_rec_num].treasureType = RANDOM_ITEM_ANY;
                        pInfos[curr_rec_num].treasureLevel = ITEM_TREASURE_LEVEL_INVALID;
                        if (test_string[0] == '"') test_string[0] = ' ';
                        str_len = strlen(test_string);
                        do {
                        ...
                        if (chance_flag) {
                            pInfos[curr_rec_num].treasureDropChance =
                                atoi(test_string);
                        } else {
                            if ((!dice_flag) && (!item_type_flag)) break;
                            pInfos[curr_rec_num].treasureDropChance = 100;
                        }
                        if (dice_flag) {
                            str_pos = 0;
                            dice_flag = false;
                        ...
                        if (item_type_flag) {
                            ...
                            pInfos[curr_rec_num].treasureLevel =
                                ItemTreasureLevel(test_string[str_pos + 1] - '0');
                            item_name = &test_string[str_pos + 2];
                            if (*item_name) {
                                if (iequals(item_name, "WEAPON"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_WEAPON;
                                else if (iequals(item_name, "ARMOR"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_ARMOR;
                                else if (iequals(item_name, "MISC"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_MICS;
                                else if (iequals(item_name, "SWORD"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_SWORD;
                                else if (iequals(item_name, "DAGGER"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_DAGGER;
                                else if (iequals(item_name, "AXE"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_AXE;
                                else if (iequals(item_name, "SPEAR"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_SPEAR;
                                else if (iequals(item_name, "BOW"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_BOW;
                                else if (iequals(item_name, "MACE"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_MACE;
                                else if (iequals(item_name, "CLUB"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_CLUB;
                                else if (iequals(item_name, "STAFF"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_STAFF;
                                else if (iequals(item_name, "LEATHER"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_LEATHER_ARMOR;
                                else if (iequals(item_name, "CHAIN"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_CHAIN_ARMOR;
                                else if (iequals(item_name, "PLATE"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_PLATE_ARMOR;
                                else if (iequals(item_name, "SHIELD"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_SHIELD;
                                else if (iequals(item_name, "HELM"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_HELMET;
                                else if (iequals(item_name, "BELT"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_BELT;
                                else if (iequals(item_name, "CAPE"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_CLOAK;
                                else if (iequals(item_name, "GAUNTLETS"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_GAUNTLETS;
                                else if (iequals(item_name, "BOOTS"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_BOOTS;
                                else if (iequals(item_name, "RING"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_RING;
                                else if (iequals(item_name, "AMULET"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_AMULET;
                                else if (iequals(item_name, "WAND"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_WAND;
                                else if (iequals(item_name, "SCROLL"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_SPELL_SCROLL;
                                else if (iequals(item_name, "GEM"))
                                    pInfos[curr_rec_num].treasureType = RANDOM_ITEM_GEM;
                            }
                        }
                    } break;
                    case 8: {
                        pInfos[curr_rec_num].bloodSplatOnDeath = false;
                        if (atoi(test_string))
                            pInfos[curr_rec_num].bloodSplatOnDeath = true;
                    } break;
                    case 9: {
                        pInfos[curr_rec_num].flying = false;
                        if (!iequals(test_string, "n")) // "Y"/"N"
                            pInfos[curr_rec_num].flying = true;
                    } break;
                    case 10: {
                        switch (tolower(test_string[0])) {
                            case 's':
                                pInfos[curr_rec_num].movementType = MONSTER_MOVEMENT_TYPE_SHORT;  // short
                                if (tolower(test_string[1]) != 'h')
                                    pInfos[curr_rec_num].movementType = MONSTER_MOVEMENT_TYPE_STATIONARY;  // stationary
                                break;  // short
                            case 'l':
                                pInfos[curr_rec_num].movementType = MONSTER_MOVEMENT_TYPE_LONG;
                                break;  // long
                            case 'm':
                                pInfos[curr_rec_num].movementType = MONSTER_MOVEMENT_TYPE_MEDIUM;
                                break;  // med
                            case 'g':
                                pInfos[curr_rec_num].movementType = MONSTER_MOVEMENT_TYPE_GLOBAL;
                                break;  // global?
                            default:
                                pInfos[curr_rec_num].movementType = MONSTER_MOVEMENT_TYPE_FREE;  // free
                        }
                    } break;
                    case 11: {
                        switch (tolower(test_string[0])) {
                            case 's':
                                pInfos[curr_rec_num].aiType = MONSTER_AI_SUICIDE;
                                break;
                            case 'w':
                                pInfos[curr_rec_num].aiType = MONSTER_AI_WIMP;
                                break;
                            case 'n':
                                pInfos[curr_rec_num].aiType = MONSTER_AI_NORMAL;
                                break;
                            default:
                                pInfos[curr_rec_num].aiType = MONSTER_AI_AGGRESSIVE;
                        }
                    } break;
                    case 12:
                        pInfos[curr_rec_num].hostilityType =
                            (MonsterHostility)atoi(test_string);
                        break;
                    case 13:
                        pInfos[curr_rec_num].baseSpeed = atoi(test_string);
                        break;
                    case 14:
                        pInfos[curr_rec_num].recoveryTime = atoi(test_string);
                        break;
                    case 15: {
                        int str_len = 0;
                        int str_pos = 0;
                        pInfos[curr_rec_num].attackPreferences = 0;
                        pInfos[curr_rec_num]
                        ...
                        for (str_pos = 0; str_pos < str_len; ++str_pos) {
                            switch (tolower(test_string[str_pos])) {
                                case '0':
                                    ...
                                    pInfos[curr_rec_num].attackPreferences |=
                    ...
                    case 16: {
                        int str_len = 0;
                        int str_pos = 0;
                        pInfos[curr_rec_num].specialAttackLevel = 1;
                        pInfos[curr_rec_num].specialAttackType =
                        ...
                        if (str_len > 1) {
                            for (str_pos = 0; str_pos < str_len; ++str_pos) {
                                if (tolower(test_string[str_pos]) == 'x') {
                                    test_string[str_pos] = '\0';
                                    pInfos[curr_rec_num].specialAttackLevel =
                                        atoi(&test_string[str_pos + 1]);
                    ...
                    case 17:
                        pInfos[curr_rec_num].attack1Type = ParseAttackType(test_string);
                        break;
                    case 18: {
                        ParseDamage(
                            test_string,
                            &pInfos[curr_rec_num].attack1DamageDiceRolls,
                            &pInfos[curr_rec_num].attack1DamageDiceSides,
                            &pInfos[curr_rec_num].attack1DamageBonus);
                    } break;
                    case 19:
                        pInfos[curr_rec_num].attack1MissileType =
                            ParseMissleAttackType(test_string);
                        break;
                    case 20:
                        pInfos[curr_rec_num].attack2Chance = atoi(test_string);
                        break;
                    case 21:
                        pInfos[curr_rec_num].attack2Type =
                            ParseAttackType(test_string);
                        break;
                    case 22: {
                        ParseDamage(
                            test_string,
                            &pInfos[curr_rec_num].attack2DamageDiceRolls,
                            &pInfos[curr_rec_num].attack2DamageDiceSides,
                            &pInfos[curr_rec_num].attack2DamageBonus);
                    } break;
                    case 23:
                        pInfos[curr_rec_num].attack2MissileType =
                            ParseMissleAttackType(test_string);
                        break;
                    case 24:
                        pInfos[curr_rec_num].spell1UseChance =
                            atoi(test_string);
                        break;
                    case 25: {
                        int param_num;
                        ...
                        if (parsed_field.uPropCount > 2) {
                            param_num = 1;
                            pInfos[curr_rec_num].spell1Id =
                                ParseSpellType(&parsed_field, &param_num);
                            pInfos[curr_rec_num].spell1SkillMastery =
                                ParseSkillValue(parsed_field.pProperties[param_num + 1], parsed_field.pProperties[param_num]);
                        } else {
                            pInfos[curr_rec_num].spell1Id = SPELL_NONE;
                            pInfos[curr_rec_num].spell1SkillMastery = CombinedSkillValue::none();
                        }
                    } break;
                    case 26:
                        pInfos[curr_rec_num].spell2UseChance =
                            atoi(test_string);
                        break;
                    case 27: {
                        int param_num;
                        ...
                        if (parsed_field.uPropCount > 2) {
                            param_num = 1;
                            pInfos[curr_rec_num].spell2Id =
                                ParseSpellType(&parsed_field, &param_num);
                            pInfos[curr_rec_num].spell2SkillMastery =
                                ParseSkillValue(parsed_field.pProperties[param_num + 1], parsed_field.pProperties[param_num]);
                        } else {
                            pInfos[curr_rec_num].spell2Id = SPELL_NONE;
                            pInfos[curr_rec_num].spell2SkillMastery = CombinedSkillValue::none();
                        }
                    } break;
                    case 28: {
                        if (tolower(test_string[0]) == 'i')
                            pInfos[curr_rec_num].resFire = 200;
                        else
                            pInfos[curr_rec_num].resFire = atoi(test_string);
                    } break;
                    case 29: {
                        if (tolower(test_string[0]) == 'i')
                            pInfos[curr_rec_num].resAir = 200;
                        else
                            pInfos[curr_rec_num].resAir = atoi(test_string);
                    } break;
                    case 30: {
                        if (tolower(test_string[0]) == 'i')
                            pInfos[curr_rec_num].resWater = 200;
                        else
                            pInfos[curr_rec_num].resWater = atoi(test_string);
                    } break;
                    case 31: {
                        if (tolower(test_string[0]) == 'i')
                            pInfos[curr_rec_num].resEarth = 200;
                        else
                            pInfos[curr_rec_num].resEarth = atoi(test_string);
                    } break;
                    case 32: {
                        if (tolower(test_string[0]) == 'i')
                            pInfos[curr_rec_num].resMind = 200;
                        else
                            pInfos[curr_rec_num].resMind = atoi(test_string);
                    } break;
                    case 33: {
                        if (tolower(test_string[0]) == 'i')
                            pInfos[curr_rec_num].resSpirit = 200;
                        else
                            pInfos[curr_rec_num].resSpirit = atoi(test_string);
                    } break;
                    case 34: {
                        if (tolower(test_string[0]) == 'i')
                            pInfos[curr_rec_num].resBody = 200;
                        else
                            pInfos[curr_rec_num].resBody = atoi(test_string);
                    } break;
                    case 35: {
                        if (tolower(test_string[0]) == 'i')
                            pInfos[curr_rec_num].resLight = 200;
                        else
                            pInfos[curr_rec_num].resLight = atoi(test_string);
                    } break;
                    case 36: {
                        if (tolower(test_string[0]) == 'i')
                            pInfos[curr_rec_num].resDark = 200;
                        else
                            pInfos[curr_rec_num].resDark = atoi(test_string);
                    } break;
                    case 37: {
                        if (tolower(test_string[0]) == 'i')
                            pInfos[curr_rec_num].resPhysical = 200;
                        else
                            pInfos[curr_rec_num].resPhysical =
                                atoi(test_string);
                    } break;
                    case 38: {
                        //                    int param_num;
                        //                    char type_flag;
                        pInfos[curr_rec_num].specialAbilityType = MONSTER_SPECIAL_ABILITY_NONE;
                        pInfos[curr_rec_num].specialAbilityDamageDiceBonus = 0;
                        strcpy(parse_str, test_string);
                        parse_str[0] = ' ';
                        parse_str[strlen(parse_str) - 1] = ' ';
                        frame_table_txt_parser(parse_str, &parsed_field);
                        if (parsed_field.uPropCount) {
                            ...
                            if (parsed_field.uPropCount < 10) {
                                if (iequals(parsed_field.pProperties[0], "shot")) {
                                    pInfos[curr_rec_num].specialAbilityType = MONSTER_SPECIAL_ABILITY_SHOT;
                                    pInfos[curr_rec_num]
                                        .specialAbilityDamageDiceBonus = atoi(
                                        (char *)(parsed_field.pProperties[1] +
                                                 1));
                                } else if (iequals(parsed_field.pProperties[0], "summon")) {
                                    pInfos[curr_rec_num].specialAbilityType = MONSTER_SPECIAL_ABILITY_SUMMON;
                                    ...
                                    pInfos[curr_rec_num].specialAbilityType = MONSTER_SPECIAL_ABILITY_EXPLODE;
                                    ParseDamage(
                                        (char *)parsed_field.pProperties[1],
                                        &pInfos[curr_rec_num]
                                             .specialAbilityDamageDiceRolls,
