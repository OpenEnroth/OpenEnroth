...
static constexpr IndexedArray<int, MonsterInfo::MonsterHostility::HOSTILITY_FRIENDLY, MonsterInfo::MonsterHostility::HOSTILITY_LONG> _4DF380_hostilityRanges = {
...
void Actor::AI_RangedAttack(unsigned int uActorID, struct AIDirection *pDir,
    ...
    if (pActors[uActorID].monsterInfo.uSpecialAbilityType == MONSTER_SPECIAL_ABILITY_SHOT) {
...
void Actor::_SelectTarget(unsigned int uActorID, Pid *OutTargetPID,
    ...
    uint v11;                   // ebx@16
    uint v12;                   // eax@16
    MonsterInfo::MonsterHostility v14;             // eax@31
    uint v15;                   // edi@43
    //uint v16;                   // ebx@45
    //uint v17;                   // eax@45
...
//----- (0040104C) --------------------------------------------------------
MonsterInfo::MonsterHostility Actor::GetActorsRelation(Actor *otherActPtr) {
        ...
        if (!pActors[actor_id].IsNotAlive()) {
            ...
            if (pActors[attacker_id.id()]._4273BB_DoesHitOtherActor(
                ...
                if (a4 == ABILITY_ATTACK1) {
                    v12 =
                        pActors[attacker_id.id()].monsterInfo.uAttack1Type;
                } else if (a4 == ABILITY_ATTACK2) {
                    v12 =
                        pActors[attacker_id.id()].monsterInfo.uAttack2Type;
                    if (pActors[actor_id]
...
void Actor::UpdateActorAI() {
    ...
    for (int v78 = 0; v78 < ai_arrays_size; ++v78) {
        ...
        MonsterInfo::MonsterHostility relationToTarget;
        if (pActor->monsterInfo.uHostilityType == MonsterInfo::HOSTILITY_FRIENDLY) {
...
ABILITY_INDEX Actor::special_ability_use_check(int a2) {
    if (this->monsterInfo.uSpecialAbilityType == MONSTER_SPECIAL_ABILITY_SUMMON && this->monsterInfo.uSpecialAbilityDamageDiceBonus < 3 && grng->random(100) < 5)
