...
void Chest::OnChestLeftClick() {
    ...
    Pointi mousePos = mouse->position();
    Pointi inventoryPos = mapToInventoryGrid(mousePos + mouse->pickedItemOffset, chestTable[chest->chestTypeId].inventoryOffset, pParty->pPickedItem.itemId != ITEM_NULL);
