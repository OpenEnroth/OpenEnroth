...
static constexpr std::array<Vec3f, 66> sphereVertPos = {  // vertices for spheres
...
static constexpr std::array<int32_t, 128 * 3> sphereVertInd = {  // indicies for triangle in sphere
