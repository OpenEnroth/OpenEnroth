...
class PriceCalculator {
 public:
     ...
     */
    static int skillLearningCostForPlayer(const Player *player, const BuildingDescr &house);
     ...
     */
    static int transportCostForPlayer(const Player *player, const BuildingDescr &house);
     ...
     */
    static int tavernRoomCostForPlayer(const Player *player, const BuildingDescr &house);
     ...
     */
    static int tavernFoodCostForPlayer(const Player *player, const BuildingDescr &house);
     ...
     */
    static int trainingCostForPlayer(const Player *player, const BuildingDescr &house);
};
