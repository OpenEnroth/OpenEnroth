...
enum class DecorationDataFlag : uint16_t {
    DECORATION_DATA_MOVE_THROUGH = 0x0001,
    DECORATION_DATA_DONT_DRAW = 0x0002,
    DECORATION_DATA_FLICKER_SLOW = 0x0004,
    DECORATION_DATA_FLICKER_AVERAGE = 0x0008,
    DECORATION_DATA_FLICKER_FAST = 0x0010,
    DECORATION_DATA_MARKER = 0x0020,
    DECORATION_DATA_SLOW_LOOP = 0x0040,
    DECORATION_DATA_EMITS_FIRE = 0x0080,
    DECORATION_DATA_SOUND_ON_DAWN = 0x0100,
    DECORATION_DATA_SOUND_ON_DUSK = 0x0200,
    DECORATION_DATA_EMITS_SMOKE = 0x0400,
};
using enum DecorationDataFlag;
MM_DECLARE_FLAGS(DecorationDataFlags, DecorationDataFlag)
MM_DECLARE_OPERATORS_FOR_FLAGS(DecorationDataFlags)
