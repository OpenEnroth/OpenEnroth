...
struct ItemData {
    ...
    // Weights for seeing this item in random loot by treasure level.
    IndexedArray<int, ITEM_TREASURE_LEVEL_FIRST_RANDOM, ITEM_TREASURE_LEVEL_LAST_RANDOM> uChanceByTreasureLvl = {{}};
