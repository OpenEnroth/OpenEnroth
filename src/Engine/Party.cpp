...
void Party::Reset() {
    ...
    pPlayers[0].Reset(CHARACTER_CLASS_KNIGHT);
    ...
    pPlayers[1].Reset(CHARACTER_CLASS_THIEF);
    ...
    pPlayers[2].Reset(CHARACTER_CLASS_CLERIC);
    ...
    pPlayers[3].Reset(CHARACTER_CLASS_SORCERER);
