...
enum class WindowType {
    ...
    WINDOW_OPTIONS = 6,
    WINDOW_UNUSED_OPTIONS = 8,
    WINDOW_BOOK = 9,
    WINDOW_DIALOGUE = 10,
    WINDOW_QUICK_REFERENCE = 12,
    WINDOW_UNUSED_PICKED_OBJECT = 15,
    WINDOW_REST = 16,
    WINDOW_TRAVEL = 17,
    WINDOW_SPELL_BOOK = 18,
    WINDOW_GREETING_NPC = 19,
    WINDOW_CHEST = 20,
    WINDOW_UNUSED_BUTTON = 22,
    WINDOW_SAVE = 23,
    WINDOW_LOAD = 24,
