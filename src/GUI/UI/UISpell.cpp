...
TargetedSpellUI_Hirelings::TargetedSpellUI_Hirelings(Pointi position, Sizei dimensions, CastSpellInfo *spellInfo, const std::string &hint)
...
TargetedSpellUI_Character::TargetedSpellUI_Character(Pointi position, Sizei dimensions, CastSpellInfo *spellInfo, const std::string &hint)
    : TargetedSpellUI(WINDOW_CastSpell, position, dimensions, spellInfo, hint) {
...
TargetedSpellUI_Actor::TargetedSpellUI_Actor(Pointi position, Sizei dimensions, CastSpellInfo *spellInfo, const std::string &hint)
    : TargetedSpellUI(WINDOW_CastSpell, position, dimensions, spellInfo, hint) {
    CreateButton({game_viewport_x, game_viewport_y}, {game_viewport_width, game_viewport_height}, 1, 0, UIMSG_CastSpell_TargetActor, 0);
}

TargetedSpellUI_ActorOrCharacter::TargetedSpellUI_ActorOrCharacter(Pointi position, Sizei dimensions, CastSpellInfo *spellInfo, const std::string &hint)
    : TargetedSpellUI(WINDOW_CastSpell, position, dimensions, spellInfo, hint) {
    CreateButton({52, 422}, {35, 0}, 2, 0, UIMSG_CastSpell_TargetCharacter, 0, Io::InputAction::SelectChar1);
    CreateButton({165, 422}, {35, 0}, 2, 0, UIMSG_CastSpell_TargetCharacter, 1, Io::InputAction::SelectChar2);
    CreateButton({280, 422}, {35, 0}, 2, 0, UIMSG_CastSpell_TargetCharacter, 2, Io::InputAction::SelectChar3);
...
TargetedSpellUI_Telekinesis::TargetedSpellUI_Telekinesis(Pointi position, Sizei dimensions, CastSpellInfo *spellInfo, const std::string &hint)
    : TargetedSpellUI(WINDOW_CastSpell, position, dimensions, spellInfo, hint) {
