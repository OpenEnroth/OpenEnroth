...
void TargetedSpellUI::CreateButtonsTargetCharacters() {
    ...
    // portrait's left edge, where the game buttons hold a constant 27 to 28. That offset should be the same for
    // all four.
    CreateButton("CastSpell_Character1", {16, 386}, {71, 71}, BUTTON_TYPE_CHARACTER, 0, UIMSG_CastSpell_TargetCharacter, 0, INPUT_ACTION_SELECT_CHAR_1);
    CreateButton("CastSpell_Character2", {129, 386}, {71, 71}, BUTTON_TYPE_CHARACTER, 0, UIMSG_CastSpell_TargetCharacter, 1, INPUT_ACTION_SELECT_CHAR_2);
    CreateButton("CastSpell_Character3", {244, 386}, {71, 71}, BUTTON_TYPE_CHARACTER, 0, UIMSG_CastSpell_TargetCharacter, 2, INPUT_ACTION_SELECT_CHAR_3);
    CreateButton("CastSpell_Character4", {354, 386}, {71, 71}, BUTTON_TYPE_CHARACTER, 0, UIMSG_CastSpell_TargetCharacter, 3, INPUT_ACTION_SELECT_CHAR_4);
}
