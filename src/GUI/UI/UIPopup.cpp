...
void CharacterUI_StatsTab_ShowHint() {
    ...
    switch (pStringNum) {
        ...
        case 26:  // Class description
            CharacterUI_DrawTooltip(localization->expand(localization->className(pParty->activeCharacter().classType)),
                ...
                if (pButton->uButtonType == BUTTON_TYPE_NORMAL && pButton->Contains(pX, pY)) {
                    switch (pButton->msg) {
                        ...
                        case UIMSG_PlayerCreationSelectClass:  // Available
                            ...
                            pStr = localization->expand(localization->className(static_cast<Class>(pButton->msg_param)));
                            break;
