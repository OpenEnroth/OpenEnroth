...
void GUIWindow_Jail::houseSpecificDialogue() {
    ...
    int vertMargin = (310 - assets->pFontArrus->CalcTextHeight(localization->str(LSTR_FOR_YOUR_NUMEROUS_CRIMES_AND_EVIL_DEEDS), jail_dialogue_window.uFrameWidth, 0)) / 2 + 18;
