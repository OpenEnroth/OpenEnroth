...
ArcomageCard pCards[87]  =  {
    ...
    { .pCardName = "Elvin Archers", .slot = 82, .card_resource_type = 3, .needed_beasts = 10, .compare_param = ArcomageCompareParam::GREATER_WALL, .to_enemy_tower = -6, .to_enemy_buildings2 = -6},
