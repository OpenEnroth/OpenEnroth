...
ArcomageCard pCards[87]  =  {
    ...
    { .pCardName = "Mother Lode", .slot = 4, .card_resource_type = 1, .needed_bricks = 4, .compare_param = CHECK_LESSER_QUARRY, .to_player_quarry_lvl = 2, .to_player_quarry_lvl2 = 1},
    ...
    { .pCardName = "Copping the Tech", .slot = 7, .card_resource_type = 1, .needed_bricks = 5, .compare_param = CHECK_LESSER_QUARRY, .to_player_quarry_lvl = 99},
    ...
    { .pCardName = "Foundations", .slot = 11, .card_resource_type = 1, .needed_bricks = 3, .compare_param = CHECK_NO_WALL, .to_player_wall = 6, .to_player_wall2 = 3},
    ...
    { .pCardName = "Parity", .slot = 43, .card_resource_type = 2, .needed_gems = 7, .compare_param = CHECK_LESSER_MAGIC, .to_player_magic_lvl = 99, .to_enemy_magic_lvl2 = 99},
    ...
    { .pCardName = "Spizzer", .slot = 78, .card_resource_type = 3, .needed_beasts = 8, .compare_param = CHECK_ENEMY_HAS_NO_WALL, .to_enemy_buildings = -10, .to_enemy_buildings2 = -6},
    { .pCardName = "Werewolf", .slot = 79, .card_resource_type = 3, .needed_beasts = 9, .to_enemy_buildings = -9},
    { .pCardName = "Corrosion Cloud", .slot = 80, .card_resource_type = 3, .needed_beasts = 11, .compare_param = CHECK_ENEMY_HAS_WALL, .to_enemy_buildings = -10, .to_enemy_buildings2 = -7},
    { .pCardName = "Unicorn", .slot = 81, .card_resource_type = 3, .needed_beasts = 9, .compare_param = CHECK_GREATER_MAGIC, .to_enemy_buildings = -12, .to_enemy_buildings2 = -8},
    { .pCardName = "Elven Archers", .slot = 82, .card_resource_type = 3, .needed_beasts = 10, .compare_param = CHECK_GREATER_WALL, .to_enemy_tower = -6, .to_enemy_buildings2 = -6},
