...
inline bool ListBoxHeader(const std::string &label, float sizeX, float sizeY) { return false;/*ImGui::ListBoxHeader(label.c_str(), {sizeX, sizeY}); */ }
inline bool ListBoxHeader(const std::string &label, int items_count) { return false;/*ImGui::ListBoxHeader(label.c_str(), items_count);*/ }
inline bool ListBoxHeader(const std::string &label, int items_count, int height_in_items) { return false;/*ImGui::ListBoxHeader(label.c_str(), items_count, height_in_items);*/ }
...
inline void Init(sol::state_view &solState, sol::table &table) {
    ...
    ImGui.set_function("InputText", InputText);
    ImGui.set_function("InputTextMultiline", InputTextMultiline);
