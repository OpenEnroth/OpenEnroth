...
bool UI_OnKeyDown(PlatformKey key) {
    for (GUIWindow *win : lWindowList) {
        ...
        if (keyboardActionMapping->IsKeyMatchAction(INPUT_ACTION_DIALOG_LEFT, key)) {
            ...
            break;
        } else if (keyboardActionMapping->IsKeyMatchAction(INPUT_ACTION_DIALOG_RIGHT, key)) {
            ...
            break;
        } else if (keyboardActionMapping->IsKeyMatchAction(INPUT_ACTION_DIALOG_DOWN, key)) {
            ...
            break;
        } else if (keyboardActionMapping->IsKeyMatchAction(INPUT_ACTION_DIALOG_UP, key)) {
            ...
            return true;
        } else if (keyboardActionMapping->IsKeyMatchAction(INPUT_ACTION_DIALOG_PRESS, key)) {
            GUIButton *pButton = win->GetControl(win->pCurrentPosActiveItem);
            engine->_messageQueue->addMessageCurrentFrame(pButton->msg, pButton->msg_param, 0);
