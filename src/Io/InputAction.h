...
enum class InputAction {
    ...
    INPUT_ACTION_TOGGLE_MOUSE_GRAB, // TODO(captainurist): drop
    INPUT_ACTION_TOGGLE_RESIZABLE, // TODO(captainurist): drop
    INPUT_ACTION_CYCLE_SCALE_FILTER, // TODO(captainurist): drop
    INPUT_ACTION_RELOAD_SHADERS, // TODO(captainurist): drop
