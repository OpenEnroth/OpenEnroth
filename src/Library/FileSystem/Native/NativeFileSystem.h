...
class NativeFileSystem : public FileSystem {
 public:
    /**
     * `UnicodeCrt` must be initialized before this is called.
     *
     ...
     */
    explicit NativeFileSystem(const std::filesystem::path &root);
     ...
     * The only place that looks at the current working directory.
     *
 ...
 private:
    ...
    /**
     * @param path                      Path inside this file system.
     * @return                          Native path for `path`.
     */
