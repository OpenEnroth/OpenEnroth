...
UNIT_TEST(Serialization, Color) {
    ...
    EXPECT_EQ(toString(red),   "0xff0000");
    EXPECT_EQ(toString(green), "0x00ff00");
    EXPECT_EQ(toString(blue),  "0x0000ff");
    EXPECT_EQ(toString(white), "0xffffff");
    EXPECT_EQ(toString(gray),  "0x808080");
    EXPECT_EQ(toString(transparentGray),
                               "0x80808080");
    EXPECT_EQ(toString(black), "0x000000");
    EXPECT_EQ(toString(invisibleBlack),
                               "0x00000000");

    EXPECT_EQ(fromString<Color>("0xff0000"), red);
    EXPECT_EQ(fromString<Color>("0xff0000ff"), red);
