...
//----- (0043AA99) --------------------------------------------------------
template <class T>
void Vec3<T>::Rotate(T sDepth, T sRotY, T sRotX, Vec3<T> v, T *outx, T *outy,
                     T *outz) {
    ...
    *outx =
        v.x +
        ((unsigned __int64)(sinf_y *
                            (signed __int64)((unsigned __int64)(cosf_x *
                                                                (signed __int64)
                                                                    sDepth) >>
                                             16)));
    *outy =
        v.y +
        ((unsigned __int64)(cosf_y *
                            (signed __int64)((unsigned __int64)(cosf_x *
                                                                (signed __int64)
                                                                    sDepth) >>
                                             16)));
...
void Vec3_float_::Normalize() {
    this->x = (1.0 / sqrt(this->x * this->x + this->y * this->y +
                          this->z * this->z)) *
              this->x;
    this->y = (1.0 / sqrt(this->x * this->x + this->y * this->y +
                          this->z * this->z)) *
              this->y;
    this->z = (1.0 / sqrt(this->x * this->x + this->y * this->y +
                          this->z * this->z)) *
              this->z;
}
