...
bool stru10::CalcFaceBounding(BLVFace *pFace, RenderVertexSoft *pFaceLimits,
    ...
    .text:0049CBB6 1 fmul    ds:flt_4D84E8			0	var8 *
    flt_4D84E8
    ...
    .text:0049CBBF 2 fmul    [ebp+var_28]			0	var8 *
    var28 1	var8 * flt_4D84E8
    ...
    .text:0049CBC5 3 fmul    [ebp+var_24]			0	var8 * var24
    768 1	var8 * var28		0 2	var8 * flt_4D84E8	0

    .text:0049CBD5 3 fst     [ebp+var_20]			0	var8 * var24
    768 1	var8 * var28		0 2	var8 * flt_4D84E8	0
                                            [var20]	var8 * var24	768

    .text:0049CBD8 3 fld     [ebp+a3]			0	a3
    -1984 1	var8 * var24		768 2	var8 * var28		0 3
    var8 * flt_4D84E8	0

    .text:0049CBDB 4 fmul    [ebp+a1.x]			0	a3 * a1.x
    1984 1	var8 * var24		768 2	var8 * var28		0 3
    var8 * flt_4D84E8	0

    .text:0049CBDE 4 fld     [ebp+a3]			0	a3
                                                            1	a3 * a1.x
    1984 2	var8 * var24		768 3	var8 * var28		0 4
    var8 * flt_4D84E8	0

    .text:0049CBE1 5 fmul    [ebp+a1.y]			0	a3 * a1.y
    0 1	a3 * a1.x		1984 2	var8 * var24		768 3	var8 *
    var28		0 4	var8 * flt_4D84E8	0 .text:0049CBE4 5 fld
    [ebp+a3]
    .text:0049CBE7 6 fmul    [ebp+a1.z]			0	a3 * a1.z
    0 1	a3 * a1.y		0 2	a3 * a1.x		1984 3	var8 *
    var24		768 4	var8 * var28		0 5	var8 *
    flt_4D84E8	0

    .text:0049CBEC 6 fstp    [ebp+var_8]
                                            var8 <- a3 * a1.z	0

    .text:0049CBEF 5 fld     [ebp+arg4]			0	arg4
    -1700 1	a3 * a1.y		0 2	a3 * a1.x		1984 3
    var8 * var24		768 4	var8 * var28		0 5	var8 *
    flt_4D84E8	0

    .text:0049CBF2 6 fsub    st, st(2)			0	arg4 - a3 * a1.x
    -3684 1	a3 * a1.y		0 2	a3 * a1.x		1984 3
    var8 * var24		768 4	var8 * var28		0 5	var8 *
    flt_4D84E8	0

    .text:0049CBF4 6 fld     st				0	arg4 - a3 * a1.x
    -3684 1	arg4 - a3 * a1.x	-3684 2	a3 * a1.y		0 3
    a3 * a1.x		1984 4	var8 * var24		768 5	var8 * var28
    0 6	var8 * flt_4D84E8	0

    .text:0049CBF6 7 fadd    st, st(6)			0	arg4 - a3 * a1.x + var8 *
    flt_4D84E8	-3684 1	arg4 - a3 * a1.x			-3684 2	a3 *
    a1.y				0 3	a3 * a1.x
    1984 4	var8 * var24				768 5	var8 * var28
    0 6	var8 * flt_4D84E8			0 .text:0049CBF8 7 fstp    dword
    ptr [ebx] [0].x <- arg4 - a3 * a1.x + var8 * flt_4D84E8		-3684

    .text:0049CBFA 6 fld     [ebp+var_18]			0	var18
    1480 1	arg4 - a3 * a1.x			-3684 2	a3 * a1.y
    0 3	a3 * a1.x				1984 4	var8 * var24
    768 5	var8 * var28				0 6	var8 *
    flt_4D84E8			0

    .text:0049CBFD 7 fsub    st, st(2)			0	var18 - a3 * a1.y
    1480 1	arg4 - a3 * a1.x			-3684 2	a3 * a1.y
    0 3	a3 * a1.x				1984 4	var8 * var24
    768 5	var8 * var28				0 6	var8 *
    flt_4D84E8			0

    .text:0049CBFF 7 fld     st				0	var18 - a3 * a1.y
    1480 1	var18 - a3 * a1.y			1480 2	arg4 - a3 * a1.x
    -3684 3	a3 * a1.y				0 4	a3 * a1.x
    1984 5	var8 * var24				768 6	var8 * var28
    0 7	var8 * flt_4D84E8			0

    .text:0049CC01 8 fadd    st, st(6)			0	var18 - a3 * a1.y + var8
    * var28	1480 1	var18 - a3 * a1.y			1480 2	arg4 -
    a3 * a1.x			-3684 3	a3 * a1.y 0 4	a3 * a1.x
    1984 5	var8 * var24				768 6	var8 * var28
    0 7	var8 * flt_4D84E8			0

    .text:0049CC03 8 fstp    dword ptr [ebx+4]
                            [0].y <- var18 - a3 * a1.y + var8 * var28
    1480

    .text:0049CC06 7 fld     [ebp+var_4]
    .text:0049CC09 8 fsub    [ebp+var_8]			0	var4 - a3 * a1.z
    768 1	var18 - a3 * a1.y			1480 2	arg4 - a3 * a1.x
    -3684 3	a3 * a1.y				0 4	a3 * a1.x
    1984 5	var8 * var24				768 6	var8 * var28
    0 7	var8 * flt_4D84E8			0 .text:0049CC0C 8 fst [ebp+a3]
                            a3 <- var4 - a3 * a1.z	768
    ...
    .text:0049CC11 8 fstp    dword ptr [ebx+8]
                            [0].z <- var4 - a3 * a1.z + var8 * var24	1536
                                                            ...
                                                            0	var18 - a3 *
    a1.y			1480 1	arg4 - a3 * a1.x
    -3684 2	a3 * a1.y				0 3	a3 * a1.x
    1984 4	var8 * var24				768 5	var8 * var28
    0 6	var8 * flt_4D84E8			0
                                                    ...
                                                    [var20]	var8 * var24
    768 [var8]	a3 * a1.z [a3]	var4 - a3 * a1.z	768


    .text:0049CC14 7 fld     st(1)
    .text:0049CC16 8 fsub    st, st(7)			0	arg4 - a3 * a1.x - var8 *
    flt_4D84E8	-3684 1	var18 - a3 * a1.y			1480 2	arg4 -
    a3 * a1.x			-3684 3	a3 * a1.y 0 4	a3 * a1.x
    1984 5	var8 * var24				768 6	var8 * var28
    0 7	var8 * flt_4D84E8			0 .text:0049CC18 8 fstp    dword
    ptr [ebx+30h] [1].x <- arg4 - a3 * a1.x - var8 * flt_4D84E8		-3684

                                                            0	var18 - a3 *
    a1.y			1480 1	arg4 - a3 * a1.x
    -3684 2	a3 * a1.y				0 3	a3 * a1.x
    1984 4	var8 * var24				768 5	var8 * var28
    0 6	var8 * flt_4D84E8			0 .text:0049CC1B 7 fsub    st,
    st(5) .text:0049CC1D 7 fstp    dword ptr [ebx+34h] [1].y <- var18 - a3 *
    a1.y - var8 * var28		1480 .text:0049CC20 6 fstp    st 0	a3 *
    a1.y				0 1	a3 * a1.x
    1984 2	var8 * var24				768 3	var8 * var28
    0 4	var8 * flt_4D84E8			0


                                                    [var20]	var8 * var24
    768 [var8]	a3 * a1.z [a3]	var4 - a3 * a1.z	768

    .text:0049CC22 5 fld     [ebp+a3]			0	var4 - a3 * a1.z
    768 1	a3 * a1.y				0 2	a3 * a1.x
    1984 3	var8 * var24				768 4	var8 * var28
    0 5	var8 * flt_4D84E8			0 .text:0049CC25 6 fsub    st,
    st(3) .text:0049CC27 6 fstp    dword ptr [ebx+38h] [1].z <- var4 - a3 * a1.z
    - var8 * var24	768 - 768 = 0

                                                            0	a3 * a1.y
    0 1	a3 * a1.x				1984 2	var8 * var24
    768 3	var8 * var28				0 4	var8 *
    flt_4D84E8			0


    .text:0049CC2A   fld     st(1)
    .text:0049CC2C 6 fadd    [ebp+arg4]			0	arg4 + a3 * a1.x
    284 1	a3 * a1.y				0 2	a3 * a1.x
    1984 3	var8 * var24				768 4	var8 * var28
    0 5	var8 * flt_4D84E8			0 .text:0049CC2F 6 fst [ebp+a3]

                                                    [var20]	var8 * var24
    768 [var8]	a3 * a1.z [a3]	arg4 + a3 * a1.x	284 .text:0049CC32 6
    fsub    st, st(5) .text:0049CC34 6 fstp    dword ptr [ebx+60h] [2].x <- arg4
    + a3 * a1.x - var8 * flt_4D84E8		284
    ...
    .text:0049CC37 5 fadd    [ebp+var_18]			0	var18 + a3 * a1.y
    1480 1	a3 * a1.x				1984 2	var8 * var24
    768 3	var8 * var28				0 4	var8 *
    flt_4D84E8			0

    .text:0049CC3A 5 fstp    st(2)				0	a3 * a1.x
    1984 1	var18 + a3 * a1.y			1480 2	var8 * var28
    0 3	var8 * flt_4D84E8			0

    .text:0049CC3C 4 fstp    st				0	var18 + a3 * a1.y
    1480 1	var8 * var28				0 2	var8 *
    flt_4D84E8			0

    .text:0049CC3E 3 fld     st				0	var18 + a3 * a1.y
    1480 1	var18 + a3 * a1.y			1480 2	var8 * var28
    0 3	var8 * flt_4D84E8			0 .text:0049CC40 4 fsub    st,
    st(2) .text:0049CC42 4 fstp    dword ptr [ebx+64h] [2].y <- var18 + a3 *
    a1.y - var8 * var28	1480

                                                            0	var18 + a3 *
    a1.y			1480 1	var8 * var28 0
                                                            2	var8 *
    flt_4D84E8			0

                                                    [var20]	var8 * var24
    768 [var8]	a3 * a1.z [a3]	arg4 + a3 * a1.x	284 .text:0049CC45 3 fld
    [ebp+var_8] .text:0049CC48 4 fadd    [ebp+var_4]			0
    var4 + a3 * a1.z			768 1	var18 + a3 * a1.y
    1480 2	var8 * var28				0 3	var8 *
    flt_4D84E8			0

    .text:0049CC4B 4 fst     [ebp+arg0]
                                                    [var20]	var8 * var24
    768 [arg0]	var4 + a3 * a1.z	768 [var8]	a3 * a1.z 0
                                                    [a3]	arg4 + a3 * a1.x
    284
    ...
    */
    ...
    if (!FindFacePlane(pOutBounding, &a1, &a3)) return false;
    ...
    if (draw_portals_loops) {
        if (!bDoNotDrawPortalFrustum) {
            ...
            pIndoorCameraD3D->do_draw_debug_line_sw(
                &v26, 0xFF0000u, &pOutBounding[0], 0xFF0000u, 0, 0);
            pIndoorCameraD3D->do_draw_debug_line_sw(
                &v26, 0xFF00u, &pOutBounding[1], 0xFF00u, 0, 0);
            pIndoorCameraD3D->do_draw_debug_line_sw(
                &v26, 0xFFu, &pOutBounding[2], 0xFFu, 0, 0);
            pIndoorCameraD3D->do_draw_debug_line_sw(
                &v26, 0xFFFFFFu, &pOutBounding[3], 0xFFFFFFu, 0, 0);
            bDoNotDrawPortalFrustum = true;
        }
        pIndoorCameraD3D->debug_outline_sw(
            pOutBounding, uNumVertices, 0x1EFF1Eu, 0.00019999999);  // bounding
    }
    //}
  ...
  if ( pEngine->uFlags & GAME_FLAGS_1_DRAW_BLV_DEBUGS)*/
    {
        ...
        if (draw_portals_loops)
            pIndoorCameraD3D->do_draw_debug_line_sw(&v25, -1, &v26, 0xFFFF00u,
                                                    0, 0);
    }
    //}
...
//----- (0049C5DA) --------------------------------------------------------
char stru10::_49C5DA(BLVFace *pFace, RenderVertexSoft *pVertices,
                     unsigned int *pNumVertices, IndoorCameraD3D_Vec4 *a5,
                     RenderVertexSoft *pOutBounding) {
...
//----- (0049C681) --------------------------------------------------------
bool stru10::CalcPortalShape(BLVFace *pFace,
...
char stru10::_49C720(RenderVertexSoft *pFaceBounding,
    ...
    if (FindFaceNormal(&pFaceBounding[0], &pFaceBounding[1], &pRayStart,
        ...
        FindFaceNormal(&pFaceBounding[1], &pFaceBounding[2], &pRayStart,
                       &pPortalDataFrustum[1]) &&
        FindFaceNormal(&pFaceBounding[2], &pFaceBounding[3], &pRayStart,
                       &pPortalDataFrustum[2]) &&
        FindFaceNormal(&pFaceBounding[3], &pFaceBounding[0], &pRayStart,
                       &pPortalDataFrustum[3]))
        return true;
    return false;
}

//----- (0049C7C5) --------------------------------------------------------
bool stru10::FindFaceNormal(RenderVertexSoft *pFaceBounding1,
    ...
    ray_dir.x = pFaceBounding1->vWorldPosition.x -
                pRayStart->x;  // get ray for cmera to bounding1
...
bool stru10::FindFacePlane(RenderVertexSoft *arg0, Vec3_float_ *a2, float *a3) {
    ...
    Vec3_float_::Cross(&v1, &v2,
                       arg0[2].vWorldPosition.x - arg0[1].vWorldPosition.x,
    ...
    if (fabsf(sqr_mag) > 1e-6f) {
        ...
        *a3 = -(arg0[0].vWorldPosition.z * v2.z +
                arg0[0].vWorldPosition.y * v2.y +
                arg0[0].vWorldPosition.x * v2.x);
        return true;
    }
    return false;
}
