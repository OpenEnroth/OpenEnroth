...
#pragma pack(pop)
    ...
    for (int i = 0; i < uNumActors; ++i) {
        ...
        memcpy(&pActors[i].pActorName, &tmp_actor->pActorName, sizeof(tmp_actor->pActorName));
        pActors[i].sNPC_ID = tmp_actor->sNPC_ID;
        pActors[i].field_22 = tmp_actor->field_22;
        pActors[i].uAttributes = tmp_actor->uAttributes;
        pActors[i].sCurrentHP = tmp_actor->sCurrentHP;
        memcpy(&pActors[i].field_2A, &tmp_actor->field_2A, sizeof(tmp_actor->field_2A));
        pActors[i].pMonsterInfo.uLevel = tmp_actor->pMonsterInfo.uLevel;
        pActors[i].pMonsterInfo.uTreasureDropChance = tmp_actor->pMonsterInfo.uTreasureDropChance;
        pActors[i].pMonsterInfo.uTreasureDiceRolls = tmp_actor->pMonsterInfo.uTreasureDiceRolls;
        pActors[i].pMonsterInfo.uTreasureDiceSides = tmp_actor->pMonsterInfo.uTreasureDiceSides;
        pActors[i].pMonsterInfo.uTreasureLevel = tmp_actor->pMonsterInfo.uTreasureLevel;
        pActors[i].pMonsterInfo.uTreasureType = tmp_actor->pMonsterInfo.uTreasureType;
        pActors[i].pMonsterInfo.uFlying = tmp_actor->pMonsterInfo.uFlying;
        pActors[i].pMonsterInfo.uMovementType = tmp_actor->pMonsterInfo.uMovementType;
        pActors[i].pMonsterInfo.uAIType = tmp_actor->pMonsterInfo.uAIType;
        pActors[i].pMonsterInfo.uHostilityType = (MonsterInfo::HostilityRadius)tmp_actor->pMonsterInfo.uHostilityType;
        pActors[i].pMonsterInfo.field_12 = tmp_actor->pMonsterInfo.field_12;
        pActors[i].pMonsterInfo.uSpecialAttackType = tmp_actor->pMonsterInfo.uSpecialAttackType;
        pActors[i].pMonsterInfo.uSpecialAttackLevel = tmp_actor->pMonsterInfo.uSpecialAttackLevel;
        pActors[i].pMonsterInfo.uAttack1Type = tmp_actor->pMonsterInfo.uAttack1Type;
        pActors[i].pMonsterInfo.uAttack1DamageDiceRolls = tmp_actor->pMonsterInfo.uAttack1DamageDiceRolls;
        pActors[i].pMonsterInfo.uAttack1DamageDiceSides = tmp_actor->pMonsterInfo.uAttack1DamageDiceSides;
        pActors[i].pMonsterInfo.uAttack1DamageBonus = tmp_actor->pMonsterInfo.uAttack1DamageBonus;
        pActors[i].pMonsterInfo.uMissleAttack1Type = tmp_actor->pMonsterInfo.uMissleAttack1Type;
        pActors[i].pMonsterInfo.uAttack2Chance = tmp_actor->pMonsterInfo.uAttack2Chance;
        pActors[i].pMonsterInfo.uAttack2Type = tmp_actor->pMonsterInfo.uAttack2Type;
        pActors[i].pMonsterInfo.uAttack2DamageDiceRolls = tmp_actor->pMonsterInfo.uAttack2DamageDiceRolls;
        pActors[i].pMonsterInfo.uAttack2DamageDiceSides = tmp_actor->pMonsterInfo.uAttack2DamageDiceSides;
        pActors[i].pMonsterInfo.uAttack2DamageBonus = tmp_actor->pMonsterInfo.uAttack2DamageBonus;
        pActors[i].pMonsterInfo.uMissleAttack2Type = tmp_actor->pMonsterInfo.uMissleAttack2Type;
        pActors[i].pMonsterInfo.uSpell1UseChance = tmp_actor->pMonsterInfo.uSpell1UseChance;
        pActors[i].pMonsterInfo.uSpell1ID = tmp_actor->pMonsterInfo.uSpell1ID;
        pActors[i].pMonsterInfo.uSpell2UseChance = tmp_actor->pMonsterInfo.uSpell2UseChance;
        pActors[i].pMonsterInfo.uSpell2ID = tmp_actor->pMonsterInfo.uSpell2ID;
        pActors[i].pMonsterInfo.uResFire = tmp_actor->pMonsterInfo.uResFire;
        pActors[i].pMonsterInfo.uResAir = tmp_actor->pMonsterInfo.uResAir;
        pActors[i].pMonsterInfo.uResWater = tmp_actor->pMonsterInfo.uResWater;
        pActors[i].pMonsterInfo.uResEarth = tmp_actor->pMonsterInfo.uResEarth;
        pActors[i].pMonsterInfo.uResMind = tmp_actor->pMonsterInfo.uResMind;
        pActors[i].pMonsterInfo.uResSpirit = tmp_actor->pMonsterInfo.uResSpirit;
        pActors[i].pMonsterInfo.uResBody = tmp_actor->pMonsterInfo.uResBody;
        pActors[i].pMonsterInfo.uResLight = tmp_actor->pMonsterInfo.uResLight;
        pActors[i].pMonsterInfo.uResDark = tmp_actor->pMonsterInfo.uResDark;
        pActors[i].pMonsterInfo.uResPhysical = tmp_actor->pMonsterInfo.uResPhysical;
        pActors[i].pMonsterInfo.uSpecialAbilityType = tmp_actor->pMonsterInfo.uSpecialAbilityType;  // 0 SPECIAL_ABILITY_TYPE_NONE
        pActors[i].pMonsterInfo.uSpecialAbilityDamageDiceRolls = tmp_actor->pMonsterInfo.uSpecialAbilityDamageDiceRolls;
        pActors[i].pMonsterInfo.uSpecialAbilityDamageDiceSides = tmp_actor->pMonsterInfo.uSpecialAbilityDamageDiceSides;
        pActors[i].pMonsterInfo.uSpecialAbilityDamageDiceBonus = tmp_actor->pMonsterInfo.uSpecialAbilityDamageDiceBonus;
        pActors[i].pMonsterInfo.uNumCharactersAttackedPerSpecialAbility = tmp_actor->pMonsterInfo.uNumCharactersAttackedPerSpecialAbility;
        pActors[i].pMonsterInfo.field_33 = tmp_actor->pMonsterInfo.field_33;
        pActors[i].pMonsterInfo.uID = tmp_actor->pMonsterInfo.uID;
        pActors[i].pMonsterInfo.bQuestMonster = tmp_actor->pMonsterInfo.bQuestMonster;
        pActors[i].pMonsterInfo.uSpellSkillAndMastery1 = tmp_actor->pMonsterInfo.uSpellSkillAndMastery1;
        pActors[i].pMonsterInfo.uSpellSkillAndMastery2 = tmp_actor->pMonsterInfo.uSpellSkillAndMastery2;
        pActors[i].pMonsterInfo.field_3C_some_special_attack = tmp_actor->pMonsterInfo.field_3C_some_special_attack;
        pActors[i].pMonsterInfo.field_3E = tmp_actor->pMonsterInfo.field_3E;
        pActors[i].pMonsterInfo.uHP = tmp_actor->pMonsterInfo.uHP;
        pActors[i].pMonsterInfo.uAC = tmp_actor->pMonsterInfo.uAC;
        pActors[i].pMonsterInfo.uExp = tmp_actor->pMonsterInfo.uExp;
        pActors[i].pMonsterInfo.uBaseSpeed = tmp_actor->pMonsterInfo.uBaseSpeed;
        pActors[i].pMonsterInfo.uRecoveryTime = tmp_actor->pMonsterInfo.uRecoveryTime;
        pActors[i].pMonsterInfo.uAttackPreference = tmp_actor->pMonsterInfo.uAttackPreference;
        pActors[i].word_000084_range_attack = tmp_actor->word_000084_range_attack;
        pActors[i].word_000086_some_monster_id = tmp_actor->word_000086_some_monster_id;  // base monster class monsterlist id
        pActors[i].uActorRadius = tmp_actor->uActorRadius;
        pActors[i].uActorHeight = tmp_actor->uActorHeight;
        pActors[i].uMovementSpeed = tmp_actor->uMovementSpeed;
        pActors[i].vPosition = tmp_actor->vPosition;
        pActors[i].vVelocity = tmp_actor->vVelocity;
        pActors[i].uYawAngle = tmp_actor->uYawAngle;
        pActors[i].uPitchAngle = tmp_actor->uPitchAngle;
        pActors[i].uSectorID = tmp_actor->uSectorID;
        pActors[i].uCurrentActionLength = tmp_actor->uCurrentActionLength;
        pActors[i].vInitialPosition = tmp_actor->vInitialPosition;
        pActors[i].vGuardingPosition = tmp_actor->vGuardingPosition;
        pActors[i].uTetherDistance = tmp_actor->uTetherDistance;
        pActors[i].uAIState = tmp_actor->uAIState;
        pActors[i].uCurrentActionAnimation = tmp_actor->uCurrentActionAnimation;
        pActors[i].uCarriedItemID = tmp_actor->uCarriedItemID;
        pActors[i].field_B6 = tmp_actor->field_B6;
        pActors[i].field_B7 = tmp_actor->field_B7;
        pActors[i].uCurrentActionTime = tmp_actor->uCurrentActionTime;
        memcpy(&pActors[i].pSpriteIDs, &tmp_actor->pSpriteIDs, sizeof(tmp_actor->pSpriteIDs));
        memcpy(&pActors[i].pSoundSampleIDs, &tmp_actor->pSoundSampleIDs, sizeof(tmp_actor->pSoundSampleIDs));  // 1 die     3 bored
        memcpy(&pActors[i].pActorBuffs, &tmp_actor->pActorBuffs, sizeof(tmp_actor->pActorBuffs));
        memcpy(&pActors[i].ActorHasItems, &tmp_actor->ActorHasItems, sizeof(tmp_actor->ActorHasItems));
        pActors[i].uGroup = tmp_actor->uGroup;
        pActors[i].uAlly = tmp_actor->uAlly;
        memcpy(&pActors[i].pScheduledJobs, &tmp_actor->pScheduledJobs, sizeof(tmp_actor->pScheduledJobs));
        pActors[i].uSummonerID = tmp_actor->uSummonerID;
        pActors[i].uLastCharacterIDToHit = tmp_actor->uLastCharacterIDToHit;
        pActors[i].dword_000334_unique_name = tmp_actor->dword_000334_unique_name;
        memcpy(&pActors[i].field_338, &tmp_actor->field_338, sizeof(tmp_actor->field_338));
    }
    free(tmp_actor);
