...
inline unsigned __int32 R5G6B5_to_A8R8G8B8(unsigned __int16 color16,
                                           unsigned char alpha) {
...
inline unsigned __int16 A8R8G8B8_to_R5G6B5(unsigned __int32 c) {
    ...
    return (unsigned __int16)((r << 11) | (g << 5) | b);
}
...
inline unsigned int R5G6B5_extract_R(unsigned __int16 c) {
    return 8 * ((c >> 11) & 0x1F);
}
inline unsigned int R5G6B5_extract_G(unsigned __int16 c) {
    return 4 * ((c >> 5) & 0x3F);
}
inline unsigned int R5G6B5_extract_B(unsigned __int16 c) {
    return 8 * ((c >> 0) & 0x1F);
}
...
inline unsigned int A1R5G5B5_extract_A(unsigned __int16 c) {
    return c & 0x8000 ? 255 : 0;
}
inline unsigned int A1R5G5B5_extract_R(unsigned __int16 c) {
    return 8 * ((c >> 10) & 0x1F);
}
inline unsigned int A1R5G5B5_extract_G(unsigned __int16 c) {
    return 8 * ((c >> 5) & 0x1F);
}
inline unsigned int A1R5G5B5_extract_B(unsigned __int16 c) {
    return 8 * ((c >> 0) & 0x1F);
}
