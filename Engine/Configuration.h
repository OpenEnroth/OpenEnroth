...
namespace Engine_
{
    class Configuration
    {
        public:
            ...
            inline void SetSaturateFaces(bool saturate) { if (saturate) flags2 |= GAME_FLAGS_2_SATURATE_LIGHTMAPS; else flags2 &= ~GAME_FLAGS_2_SATURATE_LIGHTMAPS; }
            inline bool ForceRedraw() const { return flags2 & GAME_FLAGS_2_FORCE_REDRAW; }
            inline void SetForceRedraw(bool redraw) { if (redraw) flags2 |= GAME_FLAGS_2_FORCE_REDRAW; else flags2 &= ~GAME_FLAGS_2_FORCE_REDRAW; }
