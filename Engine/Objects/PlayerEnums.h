...
/*  301 */
enum PlayerSpeech {
    SPEECH_1 = 1,  // that was too easy
    SPEECH_2 = 2,  // lets kill another
    SPEECH_3 = 3,  // its closed / come back another time
    SPEECH_4 = 4,  // chest disarm
    SPEECH_5 = 5,  // chest open fail
    SPEECH_6 = 6,  // dodge attack
    SPEECH_7 = 7,  // identify weak item
    SPEECH_8 = 8,  // identify strong item
    SPEECH_9 = 9,  // failed indentify
    SPEECH_10 = 10,  // item fixed
    SPEECH_11 = 11,  // repair failed
    SPEECH_12 = 12,  // set quick spell
    SPEECH_CantRestHere = 13,
    SPEECH_14 = 14,  // skill up
    SPEECH_NoRoom = 15,  // when placing to inventory
    SPEECH_DO_POTION_FINE = 16,
    SPEECH_17 = 17,  // potion fail
    SPEECH_18 = 18,
    SPEECH_19 = 19,
    SPEECH_20 = 20,
    SPEECH_21 = 21,  // learn spell
    ...
    SPEECH_36 = 36,  // potion drink
    SPEECH_37 = 37,  // message scroll
    SPEECH_NotEnoughGold = 38,
    SPEECH_39 = 39,  // cant use that
    SPEECH_40 = 40,  // item breaks
    SPEECH_41 = 41,  // mana drain
    SPEECH_42 = 42,  // aging attack
    SPEECH_43 = 43,  // enchant fail
    SPEECH_44 = 44,  // wince emotions?
    SPEECH_45 = 45,
    SPEECH_46 = 46,  // when entering area
    SPEECH_47 = 47,  // Let's get out of here! (Plays when leaving an area when the party alert is red or yellow)
    SPEECH_48 = 48,  // badly hurt
    SPEECH_49 = 49,  // attack with spell
    SPEECH_50 = 50,  // attack with bow
    SPEECH_51 = 51,  // kill emotion
    ...
    SPEECH_97 = 97,
    SPEECH_98 = 98,
    SPEECH_99 = 99,  // zombie/ death groan
    SPEECH_100 = 100,
    SPEECH_101 = 101,
    SPEECH_PickMe = 102,
    SPEECH_103 = 103,  // wake up
    SPEECH_IDENTIFY_MONSTER_WEAKER = 104,
    SPEECH_IDENTIFY_MONSTER_STRONGER = 105,
    SPEECH_IDENTIFY_MONSTER_106 = 106,  // failed
