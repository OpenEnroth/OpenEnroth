...
int (__stdcall *mss32_AIL_open_3D_provider)(HPROVIDER) = 0;
...
void MSS32_DLL_Initialize(const char *data_path)
{
    ...
    mss32_AIL_open_3D_provider = (int(__stdcall *)(HPROVIDER))GetProcAddress(pDll, "_AIL_open_3D_provider@4");
...
int __stdcall AIL_waveOutOpen(_DIG_DRIVER **drv, void *phWaveOut, int wDeviceID, void *pFormat)
{
    return (mss32_AIL_waveOutOpen)(drv, (HWAVEOUT *)phWaveOut, wDeviceID, (WAVEFORMAT *)pFormat);
}
